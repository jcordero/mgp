...
INSERT INTO `ciu_ciudadanos` VALUES (36,'JORGE','CORDERO','MASCULINO','1968-09-22 00:00:00','jorge.cordero@commsys.com.ar','','','','NO','NO','Pje La Piedad 16 P2 D4',NULL,'','','San Nicolas','Mar del Plata','BUENOS AIRES','ARGENTINA','','',NULL,NULL,'SI','UNIVERSITARIOS','','2013-04-08 11:54:53','CALL','1','ACTIVO','2013-02-04 12:52:34','FISICA','','Argentina'),(38,'alert(&#39;caca&#39;)','CORDERO','MASCULINO','2013-03-22 00:00:00','','','','','NO','NO','',NULL,'','','','Mar del Plata','BUENOS AIRES','ARGENTINA','','',NULL,NULL,'','','',NULL,'CALL','1','ACTIVO','2013-03-22 12:20:15','FISICA','','Argentina'),(39,'GASTON','ZANITTI','MASCULINO','1989-07-22 00:00:00','','','','','NO','NO','',NULL,'','','','Mar del Plata','BUENOS AIRES','ARGENTINA','','',NULL,NULL,'','','',NULL,'CALL','1','ACTIVO','2013-04-08 11:52:36','FISICA','','ARG');
...
CREATE TABLE `ciu_historial_contactos` (
  `chi_code` int(10) NOT NULL,
  `ciu_code` int(10) NOT NULL,
  `cse_code` int(10) DEFAULT NULL,
...
INSERT INTO `ciu_identificacion` VALUES (36,'ARG DNI 20470276');
...
INSERT INTO `sec_sequence` VALUES ('ciu_ciudadanos',39),('forms',64),('RECLAMO-2013',5),('sec_modules',11),('tic_avances',5),('tic_organismos',1),('tic_prestaciones_gis',2),('tic_tickets',5);
...
INSERT INTO `sec_users` VALUES ('1','Administrador',NULL,NULL,NULL,NULL,'admin','6bfc500738d8e9d168cd0a2024c94f5a','Activo','2013-01-09 10:48:11','Español','default',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `sec_usrgroup` VALUES ('Administradores','Administrador del sistema'),('home_operator','home operador 147');
...
CREATE TABLE `sec_usrgroup_users` (
  ...
  CONSTRAINT `fk_gu_users` FOREIGN KEY (`ugr_code`) REFERENCES `sec_usrgroup` (`ugr_code`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `sec_usrgroup_users` VALUES ('Administradores','1'),('home_operator','1');
...
INSERT INTO `tic_avance` VALUES (1,'0101',1,'2013-04-04 11:55:45',':USE_CODE_IN:','INICIADO','mensaje','INICIADO',NULL,NULL,NULL),(2,'0101',2,'2013-04-04 13:13:20',':USE_CODE_IN:','INICIADO','Un ticket con mas','INICIADO',NULL,NULL,NULL),(3,'0101',3,'2013-04-06 18:17:59',':USE_CODE_IN:','INICIADO','test #2','INICIADO',NULL,NULL,NULL),(4,'0101',4,'2013-04-08 01:25:25','1','INICIADO','Una nota','INICIADO',NULL,NULL,NULL),(5,'0101',5,'2013-04-08 11:58:42','1','INICIADO','','INICIADO',NULL,NULL,NULL);
...
INSERT INTO `tic_prestaciones` VALUES ('01','RECLAMO','LUMINARIAS','ACTIVO','2013-02-15 09:41:20','1','DOMICILIO','2 Días','web,movil,telefono,en persona','','','','','','',NULL,NULL,NULL),('0101','RECLAMO','Luminarias quemadas o rotas','ACTIVO','2013-02-17 11:12:17','1','DOMICILIO','2 Días','web,movil,telefono,en persona','','','','','','',NULL,NULL,10);
...
INSERT INTO `tic_ticket` VALUES (1,1,2013,'RECLAMO','2013-04-04 11:55:45','1','mensaje','ABIERTO','&lt;?xml version=\"1.0\" encoding=\"utf-8\"?&gt;&lt;direccion&gt;&lt;domicilio&gt;&lt;calle&gt;&lt;/calle&gt;&lt;nro&gt;2323&lt;/nro&gt;&lt;piso&gt;&lt;/piso&gt;&lt;dpto&gt;&lt;/dpto&gt;&lt;nombre_fantasia&gt;&lt;/nombre_fantasia&gt;&lt;/domicilio&gt;&lt;/direccion&gt;','CAMINO A NECOCHEA','',-38.0032813168818,-57.6032766818833,0,44,'CALL','2013-04-06 11:55:45',NULL,'',2323,NULL,'RECLAMO 1/2013'),(2,2,2013,'RECLAMO','2013-04-04 13:13:20','1','Un ticket con mas','ABIERTO','&lt;?xml version=\"1.0\" encoding=\"utf-8\"?&gt;&lt;direccion&gt;&lt;domicilio&gt;&lt;calle&gt;&lt;/calle&gt;&lt;nro&gt;3334&lt;/nro&gt;&lt;piso&gt;&lt;/piso&gt;&lt;dpto&gt;&lt;/dpto&gt;&lt;nombre_fantasia&gt;&lt;/nombre_fantasia&gt;&lt;/domicilio&gt;&lt;/direccion&gt;','NEWBERY JORGE','',-37.9740485747233,-57.6251050855191,0,45,'CALL','2013-04-06 13:13:20',NULL,'',3334,NULL,'RECLAMO 2/2013'),(3,3,2013,'RECLAMO','2013-04-06 18:17:59','1','test #2','ABIERTO','{\"calle_nombre\":\"\",\"calle\":\"00465\",\"callenro\":\"456\",\"piso\":\"\",\"dpto\":\"\",\"nombre_fantasia\":\"\",\"barrio\":\"LOMAS DE STELLA MARIS\",\"comuna\":\"\",\"lat\":\"-38.01230440493\",\"lng\":\"-57.5327426995832\"}','LOMAS DE STELLA MARIS','',-38.01230440493,-57.5327426995832,0,56,'CALL','2013-04-08 18:17:59',NULL,'',456,NULL,'RECLAMO 3/2013'),(4,4,2013,'RECLAMO','2013-04-08 01:25:25','1','Una nota','ABIERTO','{\"tipo\":\"DOMICILIO\",\"calle_nombre\":\"ALSINA\",\"calle\":\"00335\",\"callenro\":\"1432\",\"piso\":\"2\",\"dpto\":\"A\",\"nombre_fantasia\":\"\",\"barrio\":\"LOMAS DE STELLA MARIS\",\"comuna\":\"\",\"lat\":\"-38.0086358938483\",\"lng\":\"-57.5388003290637\"}','LOMAS DE STELLA MARIS','',-38.0086358938483,-57.5388003290637,0,63,'CALL','2013-04-10 01:25:25',NULL,'ALSINA',1432,NULL,'RECLAMO 4/2013'),(5,5,2013,'RECLAMO','2013-04-08 11:58:42','1','','ABIERTO','{\"tipo\":\"DOMICILIO\",\"calle_nombre\":\"CACIQUE TAYCHOCO\",\"calle\":\"04003\",\"callenro\":\"454\",\"piso\":\"\",\"dpto\":\"\",\"nombre_fantasia\":\"\",\"barrio\":\"COLONIA BARRAGAN\",\"comuna\":\"\",\"lat\":\"-38.0435833328913\",\"lng\":\"-57.6254899392465\"}','COLONIA BARRAGAN','',-38.0435833328913,-57.6254899392465,0,64,'CALL','2013-04-10 11:58:42',NULL,'CACIQUE TAYCHOCO',454,NULL,'RECLAMO 5/2013');
...
INSERT INTO `tic_ticket_ciudadano` VALUES (2,36,'2013-04-04 13:13:20','Un ticket con mas'),(3,36,'2013-04-06 18:17:59','test #2'),(4,36,'2013-04-08 01:25:25','Una nota'),(5,36,'2013-04-08 11:58:42','');
...
INSERT INTO `tic_ticket_organismos` VALUES (1,'0101',1,'PRESTADOR'),(1,'0101',1,'RESPONSABLE'),(2,'0101',1,'PRESTADOR'),(2,'0101',1,'RESPONSABLE'),(3,'0101',1,'PRESTADOR'),(3,'0101',1,'RESPONSABLE'),(4,'0101',1,'PRESTADOR'),(4,'0101',1,'RESPONSABLE'),(5,'0101',1,'PRESTADOR'),(5,'0101',1,'RESPONSABLE');
...
INSERT INTO `tic_ticket_prestaciones` VALUES (1,'0101',0,'&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;&lt;cuestionarioresultado&gt;&lt;/cuestionarioresultado&gt;','INICIADO','1.1',NULL,NULL),(2,'0101',0,'&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;&lt;cuestionarioresultado&gt;&lt;/cuestionarioresultado&gt;','INICIADO','1.1',NULL,NULL),(3,'0101',0,'&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;&lt;cuestionarioresultado&gt;&lt;/cuestionarioresultado&gt;','INICIADO','1.1',NULL,NULL),(4,'0101',0,'&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;&lt;cuestionarioresultado&gt;&lt;/cuestionarioresultado&gt;','INICIADO','1.1',NULL,NULL),(5,'0101',0,'&lt;?xml version=\"1.0\" encoding=\"UTF-8\"?&gt;&lt;cuestionarioresultado&gt;&lt;/cuestionarioresultado&gt;','INICIADO','1.1',NULL,NULL);
...
-- Dump completed on 2013-04-08 14:47:24
