...
class asunto_gr extends cform_group {
    function __construct($parent) {
        ...
        $this->m_title = 'Reclamo'; //Titulo del grupo
...
class estado_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ccal_queue")->GetField("cqu_actitud")->SetDisplayValues(Array("Name"=>"cqu_actitud", "Label"=>"Actitud", "Size"=>50, "IsForDB"=>true, "Order"=>127, "Presentation"=>"CALL_ACTITUD", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue", "InitialValue"=>"NEUTRAL"));
        $this->getClass("ccal_queue")->GetField("cqu_estado")->SetDisplayValues(Array("Name"=>"cqu_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>123, "Presentation"=>"CALL_ESTADO", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("cqu_resultado")->SetDisplayValues(Array("Name"=>"cqu_resultado", "Label"=>"Resultado", "Size"=>50, "IsForDB"=>true, "Order"=>125, "Presentation"=>"CALL_RESULTADO", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("cqu_motivo_no_conforme")->SetDisplayValues(Array("Name"=>"cqu_motivo_no_conforme", "Label"=>"Motivo no conforme", "Size"=>100, "IsForDB"=>true, "Order"=>129, "Presentation"=>"CALL_NOCONFORME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("cqu_reabrir_contacto")->SetDisplayValues(Array("Name"=>"cqu_reabrir_contacto", "Label"=>"Reabrir contacto?", "Size"=>5, "IsForDB"=>true, "Order"=>130, "Presentation"=>"SINO", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("cqu_seguir")->SetDisplayValues(Array("Name"=>"cqu_seguir", "Label"=>"Hacer seguimiento?", "Size"=>5, "IsForDB"=>true, "Order"=>131, "Presentation"=>"SINO", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsForDB"=>true, "Order"=>120, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("cqu_ingreso_fecha")->SetDisplayValues(Array("Name"=>"cqu_ingreso_fecha", "Label"=>"Ingresada", "Type"=>"datetime", "IsForDB"=>true, "Order"=>121, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("cqu_egreso_fecha")->SetDisplayValues(Array("Name"=>"cqu_egreso_fecha", "Label"=>"Cursada", "Type"=>"datetime", "IsForDB"=>true, "Order"=>122, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"ccal_queue"));
        $this->getClass("ccal_queue")->GetField("cqu_nota")->SetDisplayValues(Array("Name"=>"cqu_nota", "Label"=>"Observación", "Size"=>2000, "IsForDB"=>true, "Order"=>126, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "IsReadOnly"=>true, "Rows"=>4, "Class"=>"ccal_queue"));
    }
}
}


if( !class_exists('ccal_to_do_th5') ) {
class ccal_to_do_th5 extends ctable_handler {
    function __construct($parent) {
        parent::__construct($parent);
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("cto_estado")->SetDisplayValues(Array("Name"=>"cto_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>103, "IsMandatory"=>true, "Presentation"=>"CALL_TODO_ESTADO", "IsVisible"=>true, "InitialValue"=>"PENDIENTE"));
...
if( !class_exists('cfile_th6') ) {
class cfile_th6 extends ctable_handler {
    function __construct($parent) {
        parent::__construct($parent);
...
class ccal_queue_m extends cclass_maint {
    function __construct() {
		...
		$this->m_next_page = 'colallamadasadm.php?last=1&OP=L'; //Pagina a mostrar luego de enviar/cancelar el formulario
		$this->m_this_page = 'llamada_maint_v.php';
        ...
        //Acciones
		$this->m_action[] = new CAction('L','Listado de llamadas','','','colallamadas.php?last=1&OP=L','','Listado de llamadas','');
		...
		$this->m_handler[4] = new estado_gr($this);

        //Tablas
		$this->m_handler[5] = new ccal_to_do_th5($this);
		$this->m_handler[6] = new cfile_th6($this);

    }

    function RenderJSIncludes() {
        $html = '';
        $html.="<link rel='stylesheet' type='text/css' href='llamada_maint_v.css' media='screen,print' />";
