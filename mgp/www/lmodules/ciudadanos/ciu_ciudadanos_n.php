...
class ciu_ciudadanos_n extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_fields['ciu_email'] = new CField(Array("Name"=>"ciu_email", "Size"=>50, "IsForDB"=>true, "Order"=>106));
        $this->m_fields['ciu_tel_fijo'] = new CField(Array("Name"=>"ciu_tel_fijo", "Size"=>20, "IsForDB"=>true, "Order"=>107));
        $this->m_fields['ciu_tel_movil'] = new CField(Array("Name"=>"ciu_tel_movil", "Size"=>20, "IsForDB"=>true, "Order"=>108));
        $this->m_fields['ciu_horario_cont'] = new CField(Array("Name"=>"ciu_horario_cont", "Size"=>50, "IsForDB"=>true, "Order"=>109));
        $this->m_fields['ciu_no_llamar'] = new CField(Array("Name"=>"ciu_no_llamar", "Size"=>4, "IsForDB"=>true, "Order"=>110));
        $this->m_fields['ciu_no_email'] = new CField(Array("Name"=>"ciu_no_email", "Size"=>4, "IsForDB"=>true, "Order"=>111));
        $this->m_fields['ciu_dir_calle'] = new CField(Array("Name"=>"ciu_dir_calle", "Size"=>50, "IsForDB"=>true, "Order"=>112));
        $this->m_fields['ciu_dir_nro'] = new CField(Array("Name"=>"ciu_dir_nro", "Type"=>"int", "IsForDB"=>true, "Order"=>113));
        $this->m_fields['ciu_dir_piso'] = new CField(Array("Name"=>"ciu_dir_piso", "Size"=>5, "IsForDB"=>true, "Order"=>114));
        $this->m_fields['ciu_dir_dpto'] = new CField(Array("Name"=>"ciu_dir_dpto", "Size"=>5, "IsForDB"=>true, "Order"=>115));
        $this->m_fields['ciu_barrio'] = new CField(Array("Name"=>"ciu_barrio", "Size"=>50, "IsForDB"=>true, "Order"=>116));
        $this->m_fields['ciu_localidad'] = new CField(Array("Name"=>"ciu_localidad", "Size"=>50, "IsForDB"=>true, "Order"=>117));
        $this->m_fields['ciu_provincia'] = new CField(Array("Name"=>"ciu_provincia", "Size"=>50, "IsForDB"=>true, "Order"=>118));
        $this->m_fields['ciu_pais'] = new CField(Array("Name"=>"ciu_pais", "Size"=>50, "IsForDB"=>true, "Order"=>119));
        $this->m_fields['ciu_cod_postal'] = new CField(Array("Name"=>"ciu_cod_postal", "Size"=>6, "IsForDB"=>true, "Order"=>120));
        $this->m_fields['ciu_cgpc'] = new CField(Array("Name"=>"ciu_cgpc", "Size"=>10, "IsForDB"=>true, "Order"=>121));
        $this->m_fields['ciu_coord_x'] = new CField(Array("Name"=>"ciu_coord_x", "Type"=>"double", "IsForDB"=>true, "Order"=>122));
        $this->m_fields['ciu_coord_y'] = new CField(Array("Name"=>"ciu_coord_y", "Type"=>"double", "IsForDB"=>true, "Order"=>123));
        $this->m_fields['ciu_trabaja'] = new CField(Array("Name"=>"ciu_trabaja", "Size"=>4, "IsForDB"=>true, "Order"=>124));
        $this->m_fields['ciu_nivel_estudio'] = new CField(Array("Name"=>"ciu_nivel_estudio", "Size"=>20, "IsForDB"=>true, "Order"=>125));
        $this->m_fields['ciu_profesion'] = new CField(Array("Name"=>"ciu_profesion", "Size"=>50, "IsForDB"=>true, "Order"=>126));
        $this->m_fields['ciu_ultimo_acceso'] = new CField(Array("Name"=>"ciu_ultimo_acceso", "Type"=>"datetime", "IsForDB"=>true, "Order"=>127));
        $this->m_fields['ciu_canal_ingreso'] = new CField(Array("Name"=>"ciu_canal_ingreso", "Size"=>20, "IsForDB"=>true, "Order"=>128));
        $this->m_fields['use_code'] = new CField(Array("Name"=>"use_code", "Size"=>50, "IsForDB"=>true, "Order"=>129));
        $this->m_fields['ciu_estado'] = new CField(Array("Name"=>"ciu_estado", "Size"=>30, "IsForDB"=>true, "Order"=>130));
        $this->m_fields['ciu_tstamp'] = new CField(Array("Name"=>"ciu_tstamp", "Type"=>"datetime", "IsForDB"=>true, "Order"=>131));
        $this->m_fields['ciu_tipo_persona'] = new CField(Array("Name"=>"ciu_tipo_persona", "Size"=>20, "IsForDB"=>true, "Order"=>132));
        $this->m_fields['ciu_razon_social'] = new CField(Array("Name"=>"ciu_razon_social", "Size"=>100, "IsForDB"=>true, "Order"=>133));
        ...
        $this->m_childs['ciu_identificacion']=array();
        $this->m_childs_keys['ciu_identificacion']['ciu_code']='ciu_code';
...
<?php /* Modelo de datos ---------------------------------------- */
if( !class_exists('ciu_identificacion') ) {
class ciu_identificacion extends cobjbase {

    function __construct() {
        parent::__construct();
        $this->m_classname = "ciu_identificacion";
        $this->m_savechildsfirst = false;
        $this->m_classtype = "";
        $this->m_fileid = "";
        $this->m_connect = "primary_db";
...
class ciu_historial_contactos extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_savedb_purge_sql = "DELETE FROM ciu_historial_contactos WHERE ciu_code=:ciu_code_key:";
