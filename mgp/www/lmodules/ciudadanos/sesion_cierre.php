...
class sesion_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_ciu_sesiones")->GetField("ciu_code")->SetDisplayValues(Array("Name"=>"ciu_code", "Label"=>"Ciudadano", "Type"=>"int", "IsForDB"=>true, "Order"=>102, "Presentation"=>"CIUDADANO", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_ciu_sesiones"));
