...
class ciu_ciudadanos_n_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('ciu_code','ciu_nombres','ciu_apellido');

        $this->addAction(4,"ciudadanos_maint.php?OP=V",array(new caction_param('ciu_code')),"","ver","V","","");
        $this->addAction(4,"ciudadanos_maint.php?OP=M",array(new caction_param('ciu_code')),"","modificar","M","","");
        $this->addAction(4,"ciudadanos_maint.php?OP=P",array(new caction_param('ciu_code')),"","imprimir","P","","");
    }
    ...
    /* Campos de busqueda */
        $this->m_obj->GetField("ciu_code")->SetDisplayValues(Array("Name"=>"ciu_code", "Label"=>"Codigo", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"INT", "IsNullable"=>false));
...
class col101 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"ciu_code", "Label"=>"Codigo", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"INT", "IsNullable"=>false));
    }
}
...
class col107 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"ciu_tel_fijo", "Label"=>"Tel.Fijo", "Size"=>20, "IsForDB"=>true, "Order"=>107, "Presentation"=>"PHONE", "IsVisible"=>true));
    }
}
...
class col108 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"ciu_tel_movil", "Label"=>"Tel.Movil", "Size"=>20, "IsForDB"=>true, "Order"=>108, "Presentation"=>"PHONE", "IsVisible"=>true));
    }
}
...
class col106 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"ciu_email", "Label"=>"Email", "Size"=>50, "IsForDB"=>true, "Order"=>106, "Presentation"=>"EMAIL", "IsVisible"=>true));
    }
}
