...
class direccion_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_dir_dpto")->SetDisplayValues(Array("Name"=>"ciu_dir_dpto", "Label"=>"Dpto.", "Size"=>5, "IsForDB"=>true, "Order"=>115, "Presentation"=>"TEXT", "IsVisible"=>true, "Cols"=>5, "Class"=>"ciu_ciudadanos_n"));
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_cod_postal")->SetDisplayValues(Array("Name"=>"ciu_cod_postal", "Label"=>"Cód. Postal", "Size"=>6, "IsForDB"=>true, "Order"=>120, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"ciu_ciudadanos_n"));
