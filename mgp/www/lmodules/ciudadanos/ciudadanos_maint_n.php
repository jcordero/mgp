...
class ciu_identificacion_th5 extends ctable_handler {
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("ciu_pais_emisor")->SetDisplayValues(Array("Name"=>"ciu_pais_emisor", "Label"=>"País emisor", "Size"=>5, "IsPK"=>true, "IsForDB"=>true, "Order"=>102, "Presentation"=>"NACIONALIDAD", "IsNullable"=>false, "IsVisible"=>true));
