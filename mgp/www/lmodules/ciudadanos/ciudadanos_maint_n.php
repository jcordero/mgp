...
class datos_personales_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_tipo_persona")->SetDisplayValues(Array("Name"=>"ciu_tipo_persona", "Label"=>"Tipo persona", "Size"=>20, "IsForDB"=>true, "Order"=>132, "Presentation"=>"TIPOPERSONA", "IsVisible"=>true, "ClassParams"=>"ciu_nombres|ciu_apellido|ciu_razon_social|ciu_sexo|ciu_nacimiento|ciu_doc_nro|ciu_nacionalidad", "Class"=>"ciu_ciudadanos_n", "InitialValue"=>"FISICA"));
        ...
        $this->getClass("ciu_ciudadanos_n")->GetField("tmp_doc")->SetDisplayValues(Array("Name"=>"tmp_doc", "Label"=>"Documento", "Size"=>50, "Order"=>37, "Presentation"=>"CIUDADANO::DNI", "IsVisible"=>true, "ClassParams"=>"{\"nombre\":\"ciu_nombres\",\"apellido\":\"ciu_apellido\",\"direccion\":\"ciu_dir_calle\",\"ocupacion\":\"ciu_profesion\",\"genero\":\"ciu_sexo\",\"localidad\":\"ciu_localidad\",\"provincia\":\"ciu_provincia\",\"barrio\":\"ciu_barrio\"}", "Class"=>"ciu_ciudadanos_n"));
...
class contacto_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_no_email")->SetDisplayValues(Array("Name"=>"ciu_no_email", "Label"=>"Contacto por mail?", "Size"=>4, "IsForDB"=>true, "Order"=>111, "Presentation"=>"SINO", "IsVisible"=>true, "Class"=>"ciu_ciudadanos_n", "InitialValue"=>"NO"));
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_no_llamar")->SetDisplayValues(Array("Name"=>"ciu_no_llamar", "Label"=>"Contacto por teléfono?", "Size"=>4, "IsForDB"=>true, "Order"=>110, "Presentation"=>"SINO", "IsVisible"=>true, "Class"=>"ciu_ciudadanos_n", "InitialValue"=>"NO"));
        ...
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_tel_movil")->SetDisplayValues(Array("Name"=>"ciu_tel_movil", "Label"=>"Telefono Movil", "Size"=>20, "IsForDB"=>true, "Order"=>108, "Presentation"=>"PHONE", "IsVisible"=>true, "Class"=>"ciu_ciudadanos_n"));
...
class laboral_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_nivel_estudio")->SetDisplayValues(Array("Name"=>"ciu_nivel_estudio", "Label"=>"Nivel de Estudios", "Size"=>20, "IsForDB"=>true, "Order"=>125, "Presentation"=>"NIVEL_ESTUDIO", "IsVisible"=>true, "Class"=>"ciu_ciudadanos_n"));
...
class audit_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_tstamp")->SetDisplayValues(Array("Name"=>"ciu_tstamp", "Label"=>"Fecha de ingreso", "Type"=>"datetime", "IsForDB"=>true, "Order"=>131, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Cols"=>20, "ClassParams"=>"force", "Class"=>"ciu_ciudadanos_n"));
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_canal_ingreso")->SetDisplayValues(Array("Name"=>"ciu_canal_ingreso", "Label"=>"Canal de Ingreso", "Size"=>20, "IsForDB"=>true, "Order"=>128, "Presentation"=>"CANALDEINGRESO", "IsVisible"=>true, "IsReadOnly"=>true, "Cols"=>20, "Class"=>"ciu_ciudadanos_n", "InitialValue"=>"CALL"));
        $this->getClass("ciu_ciudadanos_n")->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsForDB"=>true, "Order"=>129, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Cols"=>20, "Class"=>"ciu_ciudadanos_n"));
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_estado")->SetDisplayValues(Array("Name"=>"ciu_estado", "Label"=>"Estado", "Size"=>30, "IsForDB"=>true, "Order"=>130, "Presentation"=>"ESTADO_CIUDADANO", "Cols"=>20, "Class"=>"ciu_ciudadanos_n", "InitialValue"=>"ACTIVO"));
    }
}
}
