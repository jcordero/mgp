...
class datos_personales_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_nacionalidad")->SetDisplayValues(Array("Name"=>"ciu_nacionalidad", "Label"=>"Nacionalidad", "Size"=>100, "IsForDB"=>true, "Order"=>134, "IsMandatory"=>true, "Presentation"=>"CIUDADANO::NACIONALIDAD", "IsVisible"=>true, "Class"=>"ciu_ciudadanos_n"));
...
class audit_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("ciu_ciudadanos_n")->GetField("ciu_estado")->SetDisplayValues(Array("Name"=>"ciu_estado", "Label"=>"Estado", "Size"=>30, "IsForDB"=>true, "Order"=>130, "Presentation"=>"CIUDADANO::ESTADO_CIUDADANO", "Cols"=>20, "Class"=>"ciu_ciudadanos_n", "InitialValue"=>"ACTIVO"));
    }
}
}
