...
class reportes_m extends cclass_maint {
    function __construct() {
		...
		$this->m_this_page = 'por_barrio.php';
    ...
    function RenderJSIncludes() {
        $html = '';
        $html.="<link rel='stylesheet' type='text/css' href='por_barrio.css' media='screen,print' />";
        $html.="<script type='text/javascript' src='por_barrio.js'></script>";
