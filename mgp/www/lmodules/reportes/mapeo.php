...
class reportes_m extends cclass_maint {
    ...
    function RenderJSIncludes() {
        $html = '';
        $html.="<link rel='stylesheet' type='text/css' href='mapeo.css' media='screen,print' />";
        $html.="<script type='text/javascript' src='mapeo.js'></script>";
        $html.="<script type='text/javascript' src='http://maps.google.com/maps/api/js?key=AIzaSyDbNPUeZ1qDaGdShuVhRIT9Cgb_NZzuPRw&sensor=false'></script>";
        $html.="<script type='text/javascript' src='markerclusterer.js'></script>";
