...
if( !class_exists('rep4') ) {
class rep4 extends cobjbase {

    function __construct() {
        parent::__construct();
        $this->m_classname = "rep4";
        ...
        $this->m_fields['tic_id_elemento'] = new CField(Array("Name"=>"tic_id_elemento", "Type"=>"int", "IsForDB"=>true, "Order"=>122));
        $this->m_fields['tpr_code'] = new CField(Array("Name"=>"tpr_code", "Size"=>20, "IsForDB"=>true, "Order"=>123, "IsNullable"=>false));
        $this->m_fields['tru_code'] = new CField(Array("Name"=>"tru_code", "Type"=>"int", "IsForDB"=>true, "Order"=>124));
        $this->m_fields['ttp_cuestionario'] = new CField(Array("Name"=>"ttp_cuestionario", "Size"=>3000, "IsForDB"=>true, "Order"=>125));
        $this->m_fields['ttp_estado'] = new CField(Array("Name"=>"ttp_estado", "Size"=>50, "IsForDB"=>true, "Order"=>126));
        $this->m_fields['ttp_prioridad'] = new CField(Array("Name"=>"ttp_prioridad", "Size"=>20, "IsForDB"=>true, "Order"=>127));
        $this->m_fields['ttp_tstamp_plazo'] = new CField(Array("Name"=>"ttp_tstamp_plazo", "Type"=>"datetime", "IsForDB"=>true, "Order"=>128));
        $this->m_fields['ttp_alerta'] = new CField(Array("Name"=>"ttp_alerta", "Type"=>"int", "IsForDB"=>true, "Order"=>129));
        $this->m_fields['tor_code'] = new CField(Array("Name"=>"tor_code", "Type"=>"int", "IsForDB"=>true, "Order"=>130));
        $this->m_fields['tto_figura'] = new CField(Array("Name"=>"tto_figura", "Size"=>50, "IsForDB"=>true, "Order"=>131));
        $this->m_fields['tmp_duracion'] = new CField(Array("Name"=>"tmp_duracion", "Size"=>50, "Type"=>"text", "Order"=>32));
        $this->m_fields['tmp_excedido'] = new CField(Array("Name"=>"tmp_excedido", "Size"=>50, "Type"=>"text", "Order"=>33));
        $this->m_fields['tmp_tstamp_out'] = new CField(Array("Name"=>"tmp_tstamp_out", "Type"=>"datetime", "Order"=>34));

        //--Contenedores de Clases dependientes
        // No hay clases dependientes

        //Consultas particulares a la base de datos
        $this->m_loaddb_sql = "SELECT tic_nro, tic_anio, tic_tipo, tic_tstamp_in, use_code, tic_nota_in, tic_estado, tic_lugar, tic_barrio, tic_cgpc, tic_coordx, tic_coordy, tic_id_cuadra, tic_forms, tic_canal, tic_tstamp_plazo, tic_tstamp_cierre, tic_calle_nombre, tic_nro_puerta, tic_nro_asociado, tic_identificador, tic_id_elemento, tpr_code, tru_code, ttp_cuestionario, ttp_estado, ttp_prioridad, ttp_tstamp_plazo, ttp_alerta, tor_code, tto_figura FROM v_tickets  WHERE tic_nro= :tic_nro_key:";
        $this->m_objfactory_sql = "SELECT tic_nro, tic_anio, tic_tipo, tic_tstamp_in, use_code, tic_nota_in, tic_estado, tic_lugar, tic_barrio, tic_cgpc, tic_coordx, tic_coordy, tic_id_cuadra, tic_forms, tic_canal, tic_tstamp_plazo, tic_tstamp_cierre, tic_calle_nombre, tic_nro_puerta, tic_nro_asociado, tic_identificador, tic_id_elemento, tpr_code, tru_code, ttp_cuestionario, ttp_estado, ttp_prioridad, ttp_tstamp_plazo, ttp_alerta, tor_code, tto_figura FROM v_tickets";
        $this->m_objfactory_suffix_sql = "order by tic_tstamp_in desc";
        $this->m_savedb_update_sql = "UPDATE v_tickets SET tic_nro= :tic_nro:, tic_anio= :tic_anio:, tic_tipo= :tic_tipo:, tic_tstamp_in= :tic_tstamp_in:, use_code= :use_code:, tic_nota_in= :tic_nota_in:, tic_estado= :tic_estado:, tic_lugar= :tic_lugar:, tic_barrio= :tic_barrio:, tic_cgpc= :tic_cgpc:, tic_coordx= :tic_coordx:, tic_coordy= :tic_coordy:, tic_id_cuadra= :tic_id_cuadra:, tic_forms= :tic_forms:, tic_canal= :tic_canal:, tic_tstamp_plazo= :tic_tstamp_plazo:, tic_tstamp_cierre= :tic_tstamp_cierre:, tic_calle_nombre= :tic_calle_nombre:, tic_nro_puerta= :tic_nro_puerta:, tic_nro_asociado= :tic_nro_asociado:, tic_identificador= :tic_identificador:, tic_id_elemento= :tic_id_elemento:, tpr_code= :tpr_code:, tru_code= :tru_code:, ttp_cuestionario= :ttp_cuestionario:, ttp_estado= :ttp_estado:, ttp_prioridad= :ttp_prioridad:, ttp_tstamp_plazo= :ttp_tstamp_plazo:, ttp_alerta= :ttp_alerta:, tor_code= :tor_code:, tto_figura= :tto_figura: WHERE tic_nro=:tic_nro_key:";
        $this->m_savedb_insert_sql = "INSERT INTO v_tickets(tic_nro, tic_anio, tic_tipo, tic_tstamp_in, use_code, tic_nota_in, tic_estado, tic_lugar, tic_barrio, tic_cgpc, tic_coordx, tic_coordy, tic_id_cuadra, tic_forms, tic_canal, tic_tstamp_plazo, tic_tstamp_cierre, tic_calle_nombre, tic_nro_puerta, tic_nro_asociado, tic_identificador, tic_id_elemento, tpr_code, tru_code, ttp_cuestionario, ttp_estado, ttp_prioridad, ttp_tstamp_plazo, ttp_alerta, tor_code, tto_figura) VALUES (:tic_nro:, :tic_anio:, :tic_tipo:, :tic_tstamp_in:, :use_code:, :tic_nota_in:, :tic_estado:, :tic_lugar:, :tic_barrio:, :tic_cgpc:, :tic_coordx:, :tic_coordy:, :tic_id_cuadra:, :tic_forms:, :tic_canal:, :tic_tstamp_plazo:, :tic_tstamp_cierre:, :tic_calle_nombre:, :tic_nro_puerta:, :tic_nro_asociado:, :tic_identificador:, :tic_id_elemento:, :tpr_code:, :tru_code:, :ttp_cuestionario:, :ttp_estado:, :ttp_prioridad:, :ttp_tstamp_plazo:, :ttp_alerta:, :tor_code:, :tto_figura:)";
