...
CREATE TABLE v_ticket_ciu (
    tic_nro INT NULL,
    tic_numero INT NULL,
    tic_anio INT NULL,
    tic_tipo VARCHAR(50) NULL,
    tic_tstamp_in DATETIME NULL,
    use_code VARCHAR(50) NULL,
    tic_nota_in VARCHAR(50) NULL,
    tic_estado VARCHAR(50) NULL,
    tic_lugar VARCHAR(50) NULL,
    tic_barrio VARCHAR(50) NULL,
    tic_cgpc VARCHAR(50) NULL,
    tic_coordx DOUBLE NULL,
    tic_coordy DOUBLE NULL,
    tic_id_cuadra VARCHAR(50) NULL,
    tic_forms VARCHAR(50) NULL,
    tic_canal VARCHAR(50) NULL,
    tic_tstamp_plazo DATETIME NULL,
    tic_tstamp_cierre DATETIME NULL,
    tic_calle_nombre VARCHAR(50) NULL,
    ...
    ciu_nombres VARCHAR(50) NULL,
    ciu_apellido VARCHAR(50) NULL,
    ciu_sexo VARCHAR(50) NULL,
    ciu_nacimiento VARCHAR(50) NULL,
    ciu_email VARCHAR(50) NULL,
    ciu_tel_fijo VARCHAR(50) NULL,
    ciu_tel_movil VARCHAR(50) NULL,
    ciu_horario_cont VARCHAR(50) NULL,
    ciu_no_llamar VARCHAR(50) NULL,
    ciu_no_email VARCHAR(50) NULL,
    ciu_dir_calle VARCHAR(50) NULL,
    ciu_dir_nro VARCHAR(50) NULL,
    ciu_dir_piso VARCHAR(50) NULL,
    ciu_dir_dpto VARCHAR(50) NULL,
    ciu_barrio VARCHAR(50) NULL,
    ciu_localidad VARCHAR(50) NULL,
    ciu_provincia VARCHAR(50) NULL,
    ciu_pais VARCHAR(50) NULL,
    ciu_cod_postal VARCHAR(50) NULL,
    ciu_cgpc VARCHAR(50) NULL,
    ciu_coord_x DOUBLE NULL,
    ciu_coord_y DOUBLE NULL,
    ciu_trabaja VARCHAR(50) NULL,
    ciu_nivel_estudio VARCHAR(50) NULL,
    ciu_profesion VARCHAR(50) NULL,
    ciu_ultimo_acceso DATETIME NULL,
    ciu_canal_ingreso VARCHAR(50) NULL,
    ciu_estado VARCHAR(50) NULL,
    ciu_tipo_persona VARCHAR(50) NULL,
    ciu_razon_social VARCHAR(50) NULL,
    ciu_nacionalidad VARCHAR(50) NULL,
    tpr_code VARCHAR(50) NULL,
    tru_code INT NULL,
    ttp_cuestionario VARCHAR(50) NULL,
    ttp_estado VARCHAR(50) NULL,
    ttp_prioridad VARCHAR(50) NULL,
    ttp_tstamp_plazo DATETIME NULL,
    ttp_alerta VARCHAR(50) NULL,
    tpr_tipo VARCHAR(50) NULL,
    tpr_detalle VARCHAR(50) NULL,
    tpr_estado VARCHAR(50) NULL,
    tpr_ubicacion VARCHAR(50) NULL,
    tpr_plazo VARCHAR(50) NULL,
    tpr_show VARCHAR(50) NULL,
    tpr_metadata VARCHAR(50) NULL,
    tpr_keywords VARCHAR(50) NULL,
    tpr_admin VARCHAR(50) NULL,
    tpr_al_inicio VARCHAR(50) NULL,
    tpr_al_final VARCHAR(50) NULL,
    tpr_al_vencimiento VARCHAR(50) NULL,
    tor_code_inspeccion VARCHAR(50) NULL,
    tor_code_verificacion VARCHAR(50) NULL,
    tpr_asociar_radio VARCHAR(50) NULL, 
    constraint pk_v_ticket_ciu primary key clustered (tic_nro,ciu_code) 
)

CREATE TABLE v_ticket_vencido (
    tic_nro INT NULL,
    tic_numero INT NULL,
    tic_anio INT NULL,
    tic_tipo VARCHAR(50) NULL,
    ...
    tpr_asociar_radio VARCHAR(50) NULL,
    vencido INT NULL,
    constraint pk_v_ticket_vencido primary key clustered (tic_nro,ciu_code) 
)