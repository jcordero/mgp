...
class class_tic_ticket_upd extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_fields['tmp_accion'] = new CField(Array("Name"=>"tmp_accion", "Size"=>50, "Order"=>25));
        $this->m_fields['tmp_nuevo_estado'] = new CField(Array("Name"=>"tmp_nuevo_estado", "Size"=>50, "Order"=>26));
        $this->m_fields['tmp_prestacion'] = new CField(Array("Name"=>"tmp_prestacion", "Size"=>50, "Order"=>27));
        $this->m_fields['tmp_nota'] = new CField(Array("Name"=>"tmp_nota", "Size"=>50, "Order"=>28));
