...
class class_v_tickets_sl extends csearchandlist {
    function __construct() {
        parent::__construct();
        $this->m_title = "Consulta de denuncias";
        $this->m_classname = "class_v_tickets_sl";
        $this->m_obj = new class_v_tickets();
        $this->m_page_name = "denabiertas.php";
        ...
        $this->addAction(12,"denuncia_maint.php?OP=V",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","ver","V","","");
        $this->addAction(12,"denuncia_maint.php?OP=M",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('responsable'),new caction_param('tpr_code','acc_tpr_code')),"","Modificar","M","","");
        $this->addAction(12,"denuncia_maint.php?OP=P",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","imprimir","P","","");
    }
...
class class_v_tickets_table extends ctable
{
    ...
    {
        parent::__construct($parent);
        $this->m_title = 'Consulta de denuncias'; //Titulo de la tabla
