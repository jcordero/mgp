...
class class_tic_prestaciones_den extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_childs_keys['class_tic_prestaciones_rubros']['tpr_tipo']='tpr_tipo';
...
class class_tic_prestaciones_rubros extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_fields['tpr_code'] = new CField(Array("Name"=>"tpr_code", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "IsNullable"=>false));
        $this->m_fields['tpr_tipo'] = new CField(Array("Name"=>"tpr_tipo", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>102, "IsNullable"=>false));
        $this->m_fields['tru_code'] = new CField(Array("Name"=>"tru_code", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>103, "IsNullable"=>false));
        $this->m_fields['tpr_prioridad'] = new CField(Array("Name"=>"tpr_prioridad", "Size"=>20, "IsForDB"=>true, "Order"=>104));
        $this->m_fields['tor_code'] = new CField(Array("Name"=>"tor_code", "Type"=>"int", "IsForDB"=>true, "Order"=>105));
        $this->m_fields['tto_figura'] = new CField(Array("Name"=>"tto_figura", "Size"=>50, "IsForDB"=>true, "Order"=>106));

        //--Contenedores de Clases dependientes
        // No hay clases dependientes

        //Consultas particulares a la base de datos
        $this->m_loaddb_sql = "SELECT tpr_code, tpr_tipo, tru_code, tpr_prioridad, tor_code, tto_figura FROM tic_prestaciones_rubros  WHERE tpr_code= :tpr_code_key: AND tpr_tipo= :tpr_tipo_key: AND tru_code= :tru_code_key:";
        $this->m_objfactory_sql = "SELECT tpr_code, tpr_tipo, tru_code, tpr_prioridad, tor_code, tto_figura FROM tic_prestaciones_rubros";
        $this->m_objfactory_suffix_sql = "";
        $this->m_savedb_update_sql = "UPDATE tic_prestaciones_rubros SET tpr_code= :tpr_code:, tpr_tipo= :tpr_tipo:, tru_code= :tru_code:, tpr_prioridad= :tpr_prioridad:, tor_code= :tor_code:, tto_figura= :tto_figura: WHERE tpr_code=:tpr_code_key: AND tpr_tipo=:tpr_tipo_key: AND tru_code=:tru_code_key:";
        $this->m_savedb_insert_sql = "INSERT INTO tic_prestaciones_rubros(tpr_code, tpr_tipo, tru_code, tpr_prioridad, tor_code, tto_figura) VALUES (:tpr_code:, :tpr_tipo:, :tru_code:, :tpr_prioridad:, :tor_code:, :tto_figura:)";
        $this->m_savedb_delete_sql = "DELETE FROM tic_prestaciones_rubros WHERE tpr_code=:tpr_code_key: AND tpr_tipo=:tpr_tipo_key: AND tru_code=:tru_code_key:";
        $this->m_savedb_purge_sql = "DELETE FROM tic_prestaciones_rubros WHERE tpr_code=:tpr_code_key: AND tpr_tipo=:tpr_tipo_key:";
