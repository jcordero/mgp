...
if( !class_exists('class_tic_prestaciones_den') ) {
class class_tic_prestaciones_den extends cobjbase {

    function __construct() {
        parent::__construct();
        $this->m_classname = "class_tic_prestaciones_den";
        ...
        $this->m_fields['eev_task'] = new CField(Array("Name"=>"eev_task", "Size"=>100, "IsForDB"=>true, "Order"=>119));
        ...
        $this->m_loaddb_sql = "SELECT tpr_code, tpr_tipo, tpr_detalle, tpr_estado, tpr_tstamp, use_code, tpr_ubicacion, tpr_plazo, tpr_show, tpr_metadata, tpr_keywords, tpr_admin, tpr_al_inicio, tpr_al_final, tpr_al_vencimiento, tor_code_inspeccion, tor_code_verificacion, tpr_asociar_radio, eev_task FROM tic_prestaciones  WHERE tpr_code= :tpr_code_key:";
        $this->m_objfactory_sql = "SELECT tpr_code, tpr_tipo, tpr_detalle, tpr_estado, tpr_tstamp, use_code, tpr_ubicacion, tpr_plazo, tpr_show, tpr_metadata, tpr_keywords, tpr_admin, tpr_al_inicio, tpr_al_final, tpr_al_vencimiento, tor_code_inspeccion, tor_code_verificacion, tpr_asociar_radio, eev_task FROM tic_prestaciones";
        $this->m_objfactory_suffix_sql = "order by tpr_detalle";
        $this->m_savedb_update_sql = "UPDATE tic_prestaciones SET tpr_code= :tpr_code:, tpr_tipo= :tpr_tipo:, tpr_detalle= :tpr_detalle:, tpr_estado= :tpr_estado:, tpr_tstamp= :tpr_tstamp:, use_code= :use_code:, tpr_ubicacion= :tpr_ubicacion:, tpr_plazo= :tpr_plazo:, tpr_show= :tpr_show:, tpr_metadata= :tpr_metadata:, tpr_keywords= :tpr_keywords:, tpr_admin= :tpr_admin:, tpr_al_inicio= :tpr_al_inicio:, tpr_al_final= :tpr_al_final:, tpr_al_vencimiento= :tpr_al_vencimiento:, tor_code_inspeccion= :tor_code_inspeccion:, tor_code_verificacion= :tor_code_verificacion:, tpr_asociar_radio= :tpr_asociar_radio:, eev_task= :eev_task: WHERE tpr_code=:tpr_code_key:";
        $this->m_savedb_insert_sql = "INSERT INTO tic_prestaciones(tpr_code, tpr_tipo, tpr_detalle, tpr_estado, tpr_tstamp, use_code, tpr_ubicacion, tpr_plazo, tpr_show, tpr_metadata, tpr_keywords, tpr_admin, tpr_al_inicio, tpr_al_final, tpr_al_vencimiento, tor_code_inspeccion, tor_code_verificacion, tpr_asociar_radio, eev_task) VALUES (:tpr_code:, :tpr_tipo:, :tpr_detalle:, :tpr_estado:, :tpr_tstamp:, :use_code:, :tpr_ubicacion:, :tpr_plazo:, :tpr_show:, :tpr_metadata:, :tpr_keywords:, :tpr_admin:, :tpr_al_inicio:, :tpr_al_final:, :tpr_al_vencimiento:, :tor_code_inspeccion:, :tor_code_verificacion:, :tpr_asociar_radio:, :eev_task:)";
...
} //-- Fin clase class_tic_prestaciones_den
}
?>
...
class class_tic_prestaciones_cuest extends cobjbase {
    ...
    function __construct() {
        ...
        //-- CField( Array(Parametros) )
        $this->m_fields['tpr_code'] = new CField(Array("Name"=>"tpr_code", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "IsNullable"=>false));
        $this->m_fields['tcu_code'] = new CField(Array("Name"=>"tcu_code", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>102, "IsNullable"=>false));
...
class class_tic_prestaciones_gis extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_fields['tpr_plazo'] = new CField(Array("Name"=>"tpr_plazo", "Size"=>20, "IsForDB"=>true, "Order"=>110));

        //--Contenedores de Clases dependientes
        // No hay clases dependientes

        //Consultas particulares a la base de datos
        $this->m_loaddb_sql = "SELECT tpr_code, tpg_code, tpg_gis_valor, tpg_gis_campo, tpg_usa_gis, tor_code, tpg_tstamp, use_code, tto_figura, tpr_plazo FROM tic_prestaciones_gis  WHERE tpr_code= :tpr_code_key: AND tpg_code= :tpg_code_key:";
        $this->m_objfactory_sql = "SELECT tpr_code, tpg_code, tpg_gis_valor, tpg_gis_campo, tpg_usa_gis, tor_code, tpg_tstamp, use_code, tto_figura, tpr_plazo FROM tic_prestaciones_gis";
        $this->m_objfactory_suffix_sql = "";
        $this->m_savedb_update_sql = "UPDATE tic_prestaciones_gis SET tpr_code= :tpr_code:, tpg_code= :tpg_code:, tpg_gis_valor= :tpg_gis_valor:, tpg_gis_campo= :tpg_gis_campo:, tpg_usa_gis= :tpg_usa_gis:, tor_code= :tor_code:, tpg_tstamp= :tpg_tstamp:, use_code= :use_code:, tto_figura= :tto_figura:, tpr_plazo= :tpr_plazo: WHERE tpr_code=:tpr_code_key: AND tpg_code=:tpg_code_key:";
        $this->m_savedb_insert_sql = "INSERT INTO tic_prestaciones_gis(tpr_code, tpg_code, tpg_gis_valor, tpg_gis_campo, tpg_usa_gis, tor_code, tpg_tstamp, use_code, tto_figura, tpr_plazo) VALUES (:tpr_code:, :tpg_code:, :tpg_gis_valor:, :tpg_gis_campo:, :tpg_usa_gis:, :tor_code:, :tpg_tstamp:, :use_code:, :tto_figura:, :tpr_plazo:)";
