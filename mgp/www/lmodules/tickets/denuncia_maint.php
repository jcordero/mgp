...
include_once "class_tic_ticket_upd_den.php";
...
class accion_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_estado';
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_tpr_code';
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_tor_code';
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_nota';
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_use_code';
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_tstamp';
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_tic_nro';
        $this->m_fields[] = 'class_tic_ticket_upd_den:acc_tic_anio';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_estado")->SetDisplayValues(Array("Name"=>"acc_estado", "Label"=>"Nuevo Estado", "Size"=>50, "Order"=>24, "Presentation"=>"ESTADO_DENUNCIA", "IsVisible"=>true, "ClassParams"=>"operaciones", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_tpr_code")->SetDisplayValues(Array("Name"=>"acc_tpr_code", "Label"=>"Prestación", "Size"=>50, "Order"=>23, "Presentation"=>"PRESTACION_TICKET", "IsVisible"=>true, "ClassParams"=>"tic_nro|tic_anio|tic_tipo", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_tor_code")->SetDisplayValues(Array("Name"=>"acc_tor_code", "Label"=>"Nuevo responsable", "Type"=>"int", "Order"=>30, "Presentation"=>"ORGANISMO", "IsVisible"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_nota")->SetDisplayValues(Array("Name"=>"acc_nota", "Label"=>"Nota", "Size"=>500, "Order"=>25, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "Rows"=>4, "Cols"=>60, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_use_code")->SetDisplayValues(Array("Name"=>"acc_use_code", "Label"=>"Operador", "Size"=>50, "Order"=>26, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "ClassParams"=>"force", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_tstamp")->SetDisplayValues(Array("Name"=>"acc_tstamp", "Label"=>"Fecha", "Type"=>"datetime", "Order"=>27, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "ClassParams"=>"force", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_tic_nro")->SetDisplayValues(Array("Name"=>"acc_tic_nro", "Label"=>"Asociado a Nro", "Type"=>"int", "Order"=>28, "Presentation"=>"INT", "IsVisible"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("acc_tic_anio")->SetDisplayValues(Array("Name"=>"acc_tic_anio", "Label"=>"Asociado a Año", "Type"=>"int", "Order"=>29, "Presentation"=>"INT", "IsVisible"=>true, "Class"=>"class_tic_ticket_upd_den"));
    }
}
}
...
class ubicacion_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_lugar';
        $this->m_fields[] = 'class_tic_ticket_upd_den:mapa';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_id_cuadra';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_coordx';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_coordy';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_barrio';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_cgpc';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_calle_nombre';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_nro_puerta';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_lugar")->SetDisplayValues(Array("Name"=>"tic_lugar", "Label"=>"Dirección", "Size"=>1000, "IsForDB"=>true, "Order"=>108, "Presentation"=>"DIRECCION", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("mapa")->SetDisplayValues(Array("Name"=>"mapa", "Label"=>"Ubicación", "Size"=>50, "Order"=>22, "Presentation"=>"MAPA", "IsVisible"=>true, "IsReadOnly"=>true, "Rows"=>150, "Cols"=>150, "ClassParams"=>"tic_coordx|tic_coordy", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_id_cuadra")->SetDisplayValues(Array("Name"=>"tic_id_cuadra", "Label"=>"IdCuadra", "Type"=>"int", "IsForDB"=>true, "Order"=>113, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_coordx")->SetDisplayValues(Array("Name"=>"tic_coordx", "Label"=>"x", "Type"=>"double", "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_coordy")->SetDisplayValues(Array("Name"=>"tic_coordy", "Label"=>"y", "Type"=>"double", "IsForDB"=>true, "Order"=>112, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_barrio")->SetDisplayValues(Array("Name"=>"tic_barrio", "Label"=>"Barrio", "Size"=>50, "IsForDB"=>true, "Order"=>109, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_cgpc")->SetDisplayValues(Array("Name"=>"tic_cgpc", "Label"=>"CGPC", "Size"=>20, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_calle_nombre")->SetDisplayValues(Array("Name"=>"tic_calle_nombre", "Label"=>"Calle", "Size"=>100, "IsForDB"=>true, "Order"=>118, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_nro_puerta")->SetDisplayValues(Array("Name"=>"tic_nro_puerta", "Label"=>"Altura", "Type"=>"int", "IsForDB"=>true, "Order"=>119, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_den"));
    }
}
}
...
class estado_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_nro';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_anio';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_tipo';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_identificador';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_tstamp_in';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_tstamp_plazo';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_tstamp_cierre';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_estado';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_canal';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_nota_in';
        $this->m_fields[] = 'class_tic_ticket_upd_den:tic_forms';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_nro")->SetDisplayValues(Array("Name"=>"tic_nro", "Label"=>"Número", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"TEXT", "IsNullable"=>false, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_anio")->SetDisplayValues(Array("Name"=>"tic_anio", "Label"=>"Año", "Type"=>"int", "IsForDB"=>true, "Order"=>102, "Presentation"=>"TEXT", "IsNullable"=>false, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsNullable"=>false, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_identificador")->SetDisplayValues(Array("Name"=>"tic_identificador", "Label"=>"Identificador", "Size"=>45, "IsForDB"=>true, "Order"=>121, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_tstamp_in")->SetDisplayValues(Array("Name"=>"tic_tstamp_in", "Label"=>"Ingreso Denuncia", "Type"=>"datetime", "IsForDB"=>true, "Order"=>104, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_tstamp_plazo")->SetDisplayValues(Array("Name"=>"tic_tstamp_plazo", "Label"=>"Fec.Cierre estimado", "Type"=>"datetime", "IsForDB"=>true, "Order"=>116, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_tstamp_cierre")->SetDisplayValues(Array("Name"=>"tic_tstamp_cierre", "Label"=>"Fec.Cierre Denuncia", "Type"=>"datetime", "IsForDB"=>true, "Order"=>117, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_estado")->SetDisplayValues(Array("Name"=>"tic_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>107, "Presentation"=>"ESTADO_TICKET", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_canal")->SetDisplayValues(Array("Name"=>"tic_canal", "Label"=>"Ingresada por", "Size"=>20, "IsForDB"=>true, "Order"=>115, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_nota_in")->SetDisplayValues(Array("Name"=>"tic_nota_in", "Label"=>"Nota al ingreso", "Size"=>500, "IsForDB"=>true, "Order"=>106, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_den"));
        $this->getClass("class_tic_ticket_upd_den")->GetField("tic_forms")->SetDisplayValues(Array("Name"=>"tic_forms", "Label"=>"Id", "Type"=>"int", "IsForDB"=>true, "Order"=>114, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_den"));
    }
}
}
...
class class_tic_avance_th3 extends ctable_handler {
    function __construct($parent) {
        ...
        $this->m_datafields['use_code_in']=4;
        $this->m_datafields['tav_tstamp_in']=5;
        $this->m_datafields['tic_estado_out']=6;
        $this->m_datafields['use_code_out']=7;
        $this->m_datafields['tav_tstamp_out']=8;
        ...
        $this->m_columns[2] = new ctable_column(2,'Est.Inicial',array('tic_estado_in','use_code_in','tav_tstamp_in'));
        $this->m_columns[3] = new ctable_column(3,'Est.Final',array('tic_estado_out','use_code_out','tav_tstamp_out'));
...
if( !class_exists('class_tic_ticket_upd_den_m') ) {
class class_tic_ticket_upd_den_m extends cclass_maint {
    function __construct() {
		...
		$this->m_obj = new class_tic_ticket_upd_den();
		$this->m_next_page = 'denabiertas.php?last=1&OP=L'; //Pagina a mostrar luego de enviar/cancelar el formulario
		$this->m_this_page = 'denuncia_maint.php';
    	$this->m_save_to_type = 'DB'; //Si el formulario accede directo a las tablas o hace una transaccion
    	$this->m_view = ''; //Si se presenta como sabana o como wizard
    	$this->m_operation_allow = 'VNMPSDB'; //Lista de operaciones permitidas
    	$this->m_operation_default = 'V'; //Operacion por defecto
    	$this->m_title = 'Actualización de una denuncia';// Titulo del formulario
    	$this->m_comment = '';// Comentario del formulario
        ...
        //Acciones
		$this->m_action[] = new CAction('P','Imprimir comprobante','','','denuncia_maint.php?OP=P','tic_nro|','Imprimir comprobante','');
		$this->m_action[] = new CAction('L','Consulta de denuncias','','','denabiertas.php?last=1&OP=L','','Consulta de denuncias','');
		$this->m_action[] = new CAction('L','Consulta de novedades','','','dennovedades.php?last=1&OP=L','','Consulta de novedades','');
...
$f = new class_tic_ticket_upd_den_m();
