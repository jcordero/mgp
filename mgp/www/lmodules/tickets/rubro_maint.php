...
class asunto_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_rubros")->GetField("tru_code")->SetDisplayValues(Array("Name"=>"tru_code", "Label"=>"Código", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"INT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Sequence"=>"tic_rubros", "Class"=>"class_tic_rubros"));
...
class estado_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_rubros")->GetField("tru_estado")->SetDisplayValues(Array("Name"=>"tru_estado", "Label"=>"Estado", "Size"=>20, "IsForDB"=>true, "Order"=>103, "Presentation"=>"ACTIVO", "IsVisible"=>true, "Class"=>"class_tic_rubros"));
        $this->getClass("class_tic_rubros")->GetField("tru_tstamp")->SetDisplayValues(Array("Name"=>"tru_tstamp", "Label"=>"Fecha Act.", "Type"=>"datetime", "IsForDB"=>true, "Order"=>104, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_rubros"));
        $this->getClass("class_tic_rubros")->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsForDB"=>true, "Order"=>105, "Presentation"=>"USER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_rubros"));
    }
}
}
...
class class_tic_rubros_m extends cclass_maint {
    function __construct() {
		...
		$this->m_this_page = 'rubro_maint.php';
    	$this->m_save_to_type = 'DB'; //Si el formulario accede directo a las tablas o hace una transaccion
    	$this->m_view = ''; //Si se presenta como sabana o como wizard
    	$this->m_operation_allow = 'VNMPSDB'; //Lista de operaciones permitidas
    	$this->m_operation_default = 'V'; //Operacion por defecto
    	$this->m_title = 'Mantenimiento de rubro';// Titulo del formulario
    	$this->m_comment = '';// Comentario del formulario
