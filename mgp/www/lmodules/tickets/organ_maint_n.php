...
class asunto_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_organismos")->GetField("tor_code")->SetDisplayValues(Array("Name"=>"tor_code", "Label"=>"Código", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"INT", "IsNullable"=>false, "IsReadOnly"=>true, "Sequence"=>"tic_organismos", "Class"=>"class_tic_organismos"));
