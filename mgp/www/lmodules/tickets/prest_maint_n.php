...
class asunto_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_prestaciones")->GetField("tpr_tipo")->SetDisplayValues(Array("Name"=>"tpr_tipo", "Label"=>"Tipo", "Size"=>20, "IsForDB"=>true, "Order"=>102, "IsMandatory"=>true, "Presentation"=>"TICKET::PRESTACIONTIPO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones", "InitialValue"=>"RECLAMO"));
        $this->getClass("class_tic_prestaciones")->GetField("tpr_ubicacion")->SetDisplayValues(Array("Name"=>"tpr_ubicacion", "Label"=>"Ubicación", "Size"=>50, "IsForDB"=>true, "Order"=>107, "IsMandatory"=>true, "Presentation"=>"TICKET::UBICACION", "IsVisible"=>true, "Class"=>"class_tic_prestaciones", "InitialValue"=>"DOMICILIO"));
        $this->getClass("class_tic_prestaciones")->GetField("tpr_plazo")->SetDisplayValues(Array("Name"=>"tpr_plazo", "Label"=>"Plazo", "Size"=>20, "IsForDB"=>true, "Order"=>108, "IsMandatory"=>true, "Presentation"=>"TICKET::PLAZO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones", "InitialValue"=>"2 Días"));
...
class ubicacion_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones")->GetField("tpr_code")->SetDisplayValues(Array("Name"=>"tpr_code", "Label"=>"Código", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "IsMandatory"=>true, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "Cols"=>10, "Class"=>"class_tic_prestaciones", "Note"=>"ej: 0102 para rama 01 subrama 02"));
    }
}
}
...
class buscar_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_prestaciones")->GetField("tpr_keywords")->SetDisplayValues(Array("Name"=>"tpr_keywords", "Label"=>"Palabras clave", "Size"=>500, "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones"));
    }
}
}
...
class estado_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones")->GetField("tpr_estado")->SetDisplayValues(Array("Name"=>"tpr_estado", "Label"=>"Estado", "Size"=>20, "IsForDB"=>true, "Order"=>104, "Presentation"=>"ACTIVO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones", "InitialValue"=>"ACTIVO"));
        $this->getClass("class_tic_prestaciones")->GetField("tpr_tstamp")->SetDisplayValues(Array("Name"=>"tpr_tstamp", "Label"=>"Fecha Act.", "Type"=>"datetime", "IsForDB"=>true, "Order"=>105, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "ClassParams"=>"force", "Class"=>"class_tic_prestaciones"));
        $this->getClass("class_tic_prestaciones")->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsForDB"=>true, "Order"=>106, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones"));
    }
}
}
...
class notifica_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones")->GetField("tpr_al_inicio")->SetDisplayValues(Array("Name"=>"tpr_al_inicio", "Label"=>"Al inicio", "Size"=>2000, "IsForDB"=>true, "Order"=>113, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones"));
        $this->getClass("class_tic_prestaciones")->GetField("tpr_al_final")->SetDisplayValues(Array("Name"=>"tpr_al_final", "Label"=>"Al final", "Size"=>2000, "IsForDB"=>true, "Order"=>114, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones"));
        $this->getClass("class_tic_prestaciones")->GetField("tpr_al_vencimiento")->SetDisplayValues(Array("Name"=>"tpr_al_vencimiento", "Label"=>"Al vencimiento", "Size"=>2000, "IsForDB"=>true, "Order"=>115, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones"));
    }
}
}
...
class class_tic_prestaciones_gis_th9 extends ctable_handler {
    function __construct($parent) {
        ...
        $this->m_columns[5] = new ctable_column(5,'Figura',array('tto_figura','tpr_plazo'));
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("tto_figura")->SetDisplayValues(Array("Name"=>"tto_figura", "Label"=>"Figura", "Size"=>50, "IsForDB"=>true, "Order"=>109, "IsMandatory"=>true, "Presentation"=>"TICKET::GISFIGURA", "IsVisible"=>true));
...
class class_tic_prestaciones_rubros_th10 extends ctable_handler {
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("tto_figura")->SetDisplayValues(Array("Name"=>"tto_figura", "Label"=>"Figura", "Size"=>50, "IsForDB"=>true, "Order"=>105, "IsMandatory"=>true, "Presentation"=>"TICKET::GISFIGURA", "IsVisible"=>true, "InitialValue"=>"RESPONSABLE"));
    }
...
class class_tic_prestaciones_m extends cclass_maint {
    function __construct() {
		...
		$this->m_this_page = 'prest_maint_n.php';
		...
		$this->m_action[] = new CAction('N','Nueva prestación','','','prest_maint_n.php?OP=N','','Nueva prestación','');
