...
include_once "class_v_tickets_sol.php";

class class_v_tickets_sol_sl extends csearchandlist {
    function __construct() {
        parent::__construct();
        $this->m_title = "Consulta de novedades de solicitudes";
        $this->m_classname = "class_v_tickets_sol_sl";
        $this->m_obj = new class_v_tickets_sol();
        $this->m_page_name = "solnovedades.php";
        ...
        $this->m_search_fields = array('tic_nro','tic_anio','tic_tipo','tto_alerta','ttp_estado','ttp_tstamp','tor_code','tpr_code','tru_code','tic_calle_nombre','tic_nro_puerta','tic_barrio','tto_figura');

        $this->addAction(14,"solicitud_maint.php?OP=V",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","ver","V","","");
        $this->addAction(14,"solicitud_maint.php?OP=M",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('responsable'),new caction_param('tpr_code','acc_tpr_code')),"","Modificar","M","","");
        $this->addAction(14,"solicitud_maint.php?OP=P",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","imprimir","P","","");
    }
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsNullable"=>false, "InitialValue"=>"SOLICITUD", "Search"=>"fix"));
        ...
        $this->m_obj->GetField("ttp_estado")->SetDisplayValues(Array("Name"=>"ttp_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>106, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
...
class col106 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"ttp_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>106, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
    }
}
...
class class_v_tickets_sol_table extends ctable
{
    function __construct($parent)
    {
        parent::__construct($parent);
        $this->m_title = 'Consulta de novedades de solicitudes'; //Titulo de la tabla
        $this->m_classname = 'class_v_tickets_sol'; //Clase contenedora de datos
