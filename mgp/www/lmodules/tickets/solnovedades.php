...
class class_v_tickets_sol_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('tic_nro','tic_identificador','tic_anio','tic_tipo','ttp_alerta','ttp_estado','tic_tstamp_in','tor_code','tpr_code','tru_code','tic_calle_nombre','tic_nro_puerta','tic_barrio','tto_figura');

        $this->addAction(15,"solicitud_maint.php?OP=V",array(new caction_param('tic_nro'),new caction_param('tpr_code','acc_tpr_code')),"","ver","V","","");
        $this->addAction(15,"solicitud_maint.php?OP=M",array(new caction_param('tic_nro'),new caction_param('responsable'),new caction_param('tpr_code','acc_tpr_code')),"","Modificar","M","","");
        $this->addAction(15,"solicitud_maint.php?OP=P",array(new caction_param('tic_nro'),new caction_param('tpr_code','acc_tpr_code')),"","imprimir","P","","");
    }
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsNullable"=>false, "InitialValue"=>"SOLICITUD", "Search"=>"fix"));
        $this->m_obj->GetField("ttp_alerta")->SetDisplayValues(Array("Name"=>"ttp_alerta", "Label"=>"Alerta", "Type"=>"int", "IsForDB"=>true, "Order"=>128, "Presentation"=>"TEXT", "InitialValue"=>"1"));
        $this->m_obj->GetField("ttp_estado")->SetDisplayValues(Array("Name"=>"ttp_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>125, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
...
class col125 extends ccolumn
{
    function __construct($parent)
    {
        ...
        //Campos de la columna
         $this->m_fields[] = new CField(Array("Name"=>"ttp_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>125, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
    }
}
