...
class asunto_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_ubicacion")->SetDisplayValues(Array("Name"=>"tpr_ubicacion", "Label"=>"Ubicación", "Size"=>50, "IsForDB"=>true, "Order"=>108, "IsMandatory"=>true, "Presentation"=>"UBICACION", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec"));
...
class ubicacion_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_code")->SetDisplayValues(Array("Name"=>"tpr_code", "Label"=>"Código", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_padre")->SetDisplayValues(Array("Name"=>"tpr_padre", "Label"=>"Prestación padre", "Size"=>20, "IsForDB"=>true, "Order"=>104, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Cols"=>10, "Class"=>"class_tic_prestaciones_rec"));
    }
}
}
...
class estado_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_estado")->SetDisplayValues(Array("Name"=>"tpr_estado", "Label"=>"Estado", "Size"=>20, "IsForDB"=>true, "Order"=>105, "Presentation"=>"ACTIVO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_tstamp")->SetDisplayValues(Array("Name"=>"tpr_tstamp", "Label"=>"Fecha Act.", "Type"=>"datetime", "IsForDB"=>true, "Order"=>106, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsForDB"=>true, "Order"=>107, "Presentation"=>"USER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_rec"));
    }
}
}
...
class class_tic_prestaciones_rec_m extends cclass_maint {
    function __construct() {
		...
		$this->m_next_page = 'recprestaciones.php?last=1&OP=L'; //Pagina a mostrar luego de enviar/cancelar el formulario
		$this->m_this_page = 'recprest_maint.php';
    	$this->m_save_to_type = 'DB'; //Si el formulario accede directo a las tablas o hace una transaccion
    	$this->m_view = ''; //Si se presenta como sabana o como wizard
    	$this->m_operation_allow = 'VNMPSDB'; //Lista de operaciones permitidas
    	$this->m_operation_default = 'V'; //Operacion por defecto
    	$this->m_title = 'Mantenimiento de prestación';// Titulo del formulario
    	$this->m_comment = '';// Comentario del formulario
