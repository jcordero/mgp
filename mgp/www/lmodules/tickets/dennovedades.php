...
class class_v_tickets_sl extends csearchandlist {
    function __construct() {
        parent::__construct();
        $this->m_title = "Consulta de novedades de denuncias";
        $this->m_classname = "class_v_tickets_sl";
        $this->m_obj = new class_v_tickets();
        $this->m_page_name = "dennovedades.php";
        ...
        $this->m_search_fields = array('tic_nro','tic_anio','tic_tipo','tto_alerta','ttp_estado','ttp_tstamp','tor_code','tpr_code','tru_code','tic_calle_nombre','tic_nro_puerta','tic_barrio');

        $this->addAction(13,"denuncia_maint.php?OP=V",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","ver","V","","");
        $this->addAction(13,"denuncia_maint.php?OP=M",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('responsable'),new caction_param('tpr_code','acc_tpr_code')),"","Modificar","M","","");
        $this->addAction(13,"denuncia_maint.php?OP=P",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","imprimir","P","","");
    }
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsNullable"=>false, "InitialValue"=>"DENUNCIA", "Search"=>"fix"));
...
class class_v_tickets_table extends ctable
{
    ...
    {
        parent::__construct($parent);
        $this->m_title = 'Consulta de novedades de denuncias'; //Titulo de la tabla
