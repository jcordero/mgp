...
class class_v_tickets_sl extends csearchandlist {
    function __construct() {
        ...
        $this->addAction(14,"denuncia_maint.php?OP=V",array(new caction_param('tic_nro'),new caction_param('tpr_code','acc_tpr_code')),"","ver","V","","");
        $this->addAction(14,"denuncia_maint.php?OP=M",array(new caction_param('tic_nro'),new caction_param('responsable'),new caction_param('tpr_code','acc_tpr_code')),"","Modificar","M","","");
        $this->addAction(14,"denuncia_maint.php?OP=P",array(new caction_param('tic_nro'),new caction_param('tpr_code','acc_tpr_code')),"","imprimir","P","","");
    }
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsNullable"=>false, "InitialValue"=>"DENUNCIA", "Search"=>"fix"));
