...
class class_v_tickets_sol_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('tic_nro','tic_identificador','tic_anio','tic_tipo','ttp_estado','tic_tstamp_in','tor_code','tpr_code','tru_code','tic_calle_nombre','tic_nro_puerta','tic_barrio','tto_figura');

        $this->addAction(14,"solicitud_maint.php?OP=V",array(new caction_param('tic_nro'),new caction_param('tpr_code','acc_tpr_code')),"","ver","V","","");
        $this->addAction(14,"solicitud_maint.php?OP=M",array(new caction_param('tic_nro'),new caction_param('responsable'),new caction_param('tpr_code','acc_tpr_code')),"","Modificar","M","","");
        $this->addAction(14,"solicitud_maint.php?OP=P",array(new caction_param('tic_nro'),new caction_param('tpr_code','acc_tpr_code')),"","imprimir","P","","");
    }
