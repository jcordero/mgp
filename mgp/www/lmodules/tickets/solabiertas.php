...
class class_v_tickets_sol_sl extends csearchandlist {
    function __construct() {
        ...
        $this->m_search_fields = array('tic_nro','tic_anio','tic_tipo','ttp_estado','ttp_tstamp','tor_code','tpr_code','tru_code','tic_calle_nombre','tic_nro_puerta','tic_barrio','tto_figura');

        $this->addAction(13,"solicitud_maint.php?OP=V",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","ver","V","","");
        $this->addAction(13,"solicitud_maint.php?OP=M",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('responsable'),new caction_param('tpr_code','acc_tpr_code')),"","Modificar","M","","");
        $this->addAction(13,"solicitud_maint.php?OP=P",array(new caction_param('tic_nro'),new caction_param('tic_anio'),new caction_param('tic_tipo'),new caction_param('tpr_code','acc_tpr_code')),"","imprimir","P","","");
    }
...
class class_v_tickets_sol_table extends ctable
{
    ...
    {
        parent::__construct($parent);
        $this->m_title = 'Consulta de solicitudes'; //Titulo de la tabla
