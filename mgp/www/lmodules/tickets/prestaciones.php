...
class class_tic_prestaciones_sl extends csearchandlist {
    function __construct() {
        ...
        $this->addAction(7,"prest_maint.php?OP=V",array(new caction_param('tpr_code'),new caction_param('tpr_tipo')),"","ver","V","","");
        $this->addAction(7,"prest_maint.php?OP=M",array(new caction_param('tpr_code'),new caction_param('tpr_tipo')),"","modifica","M","","");
    }
    ...
    /* Campos de busqueda */
        ...
        $this->m_obj->GetField("tpr_tipo")->SetDisplayValues(Array("Name"=>"tpr_tipo", "Label"=>"Tipo", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>102, "Presentation"=>"PRESTACIONTIPO", "IsNullable"=>false, "IsVisible"=>true));
