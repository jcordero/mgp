...
class class_tic_ticket extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_fields['tipo_georef'] = new CField(Array("Name"=>"tipo_georef", "Size"=>50, "Order"=>26));
        $this->m_fields['mapa'] = new CField(Array("Name"=>"mapa", "Type"=>"int", "Order"=>27));
        $this->m_fields['calle_nombre'] = new CField(Array("Name"=>"calle_nombre", "Size"=>100, "Order"=>28));
        $this->m_fields['calle'] = new CField(Array("Name"=>"calle", "Type"=>"int", "Order"=>29));
        $this->m_fields['calle_nombre2'] = new CField(Array("Name"=>"calle_nombre2", "Size"=>100, "Order"=>30));
        $this->m_fields['calle2'] = new CField(Array("Name"=>"calle2", "Type"=>"int", "Order"=>31));
        $this->m_fields['callenro'] = new CField(Array("Name"=>"callenro", "Type"=>"int", "Order"=>32));
        $this->m_fields['piso'] = new CField(Array("Name"=>"piso", "Type"=>"int", "Order"=>33));
        $this->m_fields['dpto'] = new CField(Array("Name"=>"dpto", "Size"=>20, "Order"=>34));
        $this->m_fields['nombre_fantasia'] = new CField(Array("Name"=>"nombre_fantasia", "Size"=>100, "Order"=>35));
        $this->m_fields['alternativa'] = new CField(Array("Name"=>"alternativa", "Size"=>20, "Order"=>36));
        $this->m_fields['villa'] = new CField(Array("Name"=>"villa", "Size"=>100, "Order"=>37));
        $this->m_fields['vilmanzana'] = new CField(Array("Name"=>"vilmanzana", "Size"=>20, "Order"=>38));
        $this->m_fields['vilcasa'] = new CField(Array("Name"=>"vilcasa", "Size"=>20, "Order"=>39));
        $this->m_fields['plaza'] = new CField(Array("Name"=>"plaza", "Size"=>100, "Order"=>40));
        $this->m_fields['orgpublico'] = new CField(Array("Name"=>"orgpublico", "Size"=>100, "Order"=>41));
        $this->m_fields['orgsector'] = new CField(Array("Name"=>"orgsector", "Size"=>100, "Order"=>42));
        $this->m_fields['cementerio'] = new CField(Array("Name"=>"cementerio", "Size"=>100, "Order"=>43));
        $this->m_fields['sepultura'] = new CField(Array("Name"=>"sepultura", "Size"=>100, "Order"=>44));
        $this->m_fields['sepsector'] = new CField(Array("Name"=>"sepsector", "Size"=>100, "Order"=>45));
        $this->m_fields['sepcalle'] = new CField(Array("Name"=>"sepcalle", "Size"=>100, "Order"=>46));
        $this->m_fields['sepnumero'] = new CField(Array("Name"=>"sepnumero", "Size"=>100, "Order"=>47));
        $this->m_fields['sepfila'] = new CField(Array("Name"=>"sepfila", "Size"=>100, "Order"=>48));
        $this->m_fields['mapa_lum'] = new CField(Array("Name"=>"mapa_lum", "Type"=>"int", "Order"=>49));
        $this->m_fields['calle_nombre_lum'] = new CField(Array("Name"=>"calle_nombre_lum", "Size"=>100, "Order"=>50));
        $this->m_fields['calle_lum'] = new CField(Array("Name"=>"calle_lum", "Type"=>"int", "Order"=>51));
        $this->m_fields['calle_nombre2_lum'] = new CField(Array("Name"=>"calle_nombre2_lum", "Size"=>100, "Order"=>52));
        $this->m_fields['calle2_lum'] = new CField(Array("Name"=>"calle2_lum", "Type"=>"int", "Order"=>53));
        $this->m_fields['callenro_lum'] = new CField(Array("Name"=>"callenro_lum", "Type"=>"int", "Order"=>54));
        $this->m_fields['tic_barrio_lum'] = new CField(Array("Name"=>"tic_barrio_lum", "Size"=>100, "Order"=>55));
        $this->m_fields['tic_cgpc_lum'] = new CField(Array("Name"=>"tic_cgpc_lum", "Size"=>100, "Order"=>56));
        $this->m_fields['id_luminaria'] = new CField(Array("Name"=>"id_luminaria", "Size"=>100, "Order"=>57));
        $this->m_fields['alternativa_lum'] = new CField(Array("Name"=>"alternativa_lum", "Size"=>20, "Order"=>58));
