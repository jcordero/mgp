...
class class_tic_ticket extends cobjbase {
    ...
    function __construct() {
        ...
        $this->m_fields['callenro'] = new CField(Array("Name"=>"callenro", "Type"=>"int", "Order"=>30));
        $this->m_fields['piso'] = new CField(Array("Name"=>"piso", "Type"=>"int", "Order"=>31));
        $this->m_fields['dpto'] = new CField(Array("Name"=>"dpto", "Size"=>20, "Order"=>32));
        $this->m_fields['nombre_fantasia'] = new CField(Array("Name"=>"nombre_fantasia", "Size"=>100, "Order"=>33));
        $this->m_fields['villa'] = new CField(Array("Name"=>"villa", "Size"=>100, "Order"=>34));
        $this->m_fields['vilmanzana'] = new CField(Array("Name"=>"vilmanzana", "Size"=>20, "Order"=>35));
        $this->m_fields['vilcasa'] = new CField(Array("Name"=>"vilcasa", "Size"=>20, "Order"=>36));
        $this->m_fields['plaza'] = new CField(Array("Name"=>"plaza", "Size"=>100, "Order"=>37));
        $this->m_fields['orgpublico'] = new CField(Array("Name"=>"orgpublico", "Size"=>100, "Order"=>38));
        $this->m_fields['orgsector'] = new CField(Array("Name"=>"orgsector", "Size"=>100, "Order"=>39));
        $this->m_fields['cementerio'] = new CField(Array("Name"=>"cementerio", "Size"=>100, "Order"=>40));
        $this->m_fields['sepultura'] = new CField(Array("Name"=>"sepultura", "Size"=>100, "Order"=>41));
        $this->m_fields['sepsector'] = new CField(Array("Name"=>"sepsector", "Size"=>100, "Order"=>42));
        $this->m_fields['sepcalle'] = new CField(Array("Name"=>"sepcalle", "Size"=>100, "Order"=>43));
        $this->m_fields['sepnumero'] = new CField(Array("Name"=>"sepnumero", "Size"=>100, "Order"=>44));
        $this->m_fields['sepfila'] = new CField(Array("Name"=>"sepfila", "Size"=>100, "Order"=>45));
