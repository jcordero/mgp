...
include_once "class_tic_prestaciones_den.php";
...
class asunto_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_detalle';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_tipo';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_ubicacion';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_plazo';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_show';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_detalle")->SetDisplayValues(Array("Name"=>"tpr_detalle", "Label"=>"Detalle", "Size"=>100, "IsForDB"=>true, "Order"=>103, "IsMandatory"=>true, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_tipo")->SetDisplayValues(Array("Name"=>"tpr_tipo", "Label"=>"Tipo", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>102, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_den", "InitialValue"=>"DENUNCIA"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_ubicacion")->SetDisplayValues(Array("Name"=>"tpr_ubicacion", "Label"=>"Ubicación", "Size"=>50, "IsForDB"=>true, "Order"=>108, "IsMandatory"=>true, "Presentation"=>"UBICACION", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den", "InitialValue"=>"DOMICILIO"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_plazo")->SetDisplayValues(Array("Name"=>"tpr_plazo", "Label"=>"Plazo", "Size"=>20, "IsForDB"=>true, "Order"=>109, "IsMandatory"=>true, "Presentation"=>"PLAZO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_show")->SetDisplayValues(Array("Name"=>"tpr_show", "Label"=>"Mostrar en", "Size"=>50, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den"));
    }
}
}
...
class ubicacion_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_code';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_padre';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_code")->SetDisplayValues(Array("Name"=>"tpr_code", "Label"=>"Código", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "IsMandatory"=>true, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "Cols"=>10, "Class"=>"class_tic_prestaciones_den"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_padre")->SetDisplayValues(Array("Name"=>"tpr_padre", "Label"=>"Prestación padre", "Size"=>20, "IsForDB"=>true, "Order"=>104, "Presentation"=>"TEXT", "IsVisible"=>true, "Cols"=>10, "Class"=>"class_tic_prestaciones_den"));
    }
}
}
...
class buscar_gr extends cform_group {
    function __construct($parent) {
        parent::__construct($parent);
        $this->m_title = 'Búsqueda'; //Titulo del grupo
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_metadata';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_keywords';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_metadata")->SetDisplayValues(Array("Name"=>"tpr_metadata", "Label"=>"Descripción", "Size"=>3000, "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "Rows"=>5, "Cols"=>60, "Class"=>"class_tic_prestaciones_den"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_keywords")->SetDisplayValues(Array("Name"=>"tpr_keywords", "Label"=>"Palabras clave", "Size"=>500, "IsForDB"=>true, "Order"=>112, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den"));
    }
}
}
...
class estado_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_estado';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_tstamp';
        $this->m_fields[] = 'class_tic_prestaciones_den:use_code';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_estado")->SetDisplayValues(Array("Name"=>"tpr_estado", "Label"=>"Estado", "Size"=>20, "IsForDB"=>true, "Order"=>105, "Presentation"=>"ACTIVO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den", "InitialValue"=>"ACTIVO"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_tstamp")->SetDisplayValues(Array("Name"=>"tpr_tstamp", "Label"=>"Fecha Act.", "Type"=>"datetime", "IsForDB"=>true, "Order"=>106, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "ClassParams"=>"force", "Class"=>"class_tic_prestaciones_den"));
        $this->getClass("class_tic_prestaciones_den")->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsForDB"=>true, "Order"=>107, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_den"));
    }
}
}
...
class admin_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_admin';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_admin")->SetDisplayValues(Array("Name"=>"tpr_admin", "Label"=>"Administrable por", "Size"=>50, "IsForDB"=>true, "Order"=>113, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_den"));
    }
}
}
...
class notifica_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_al_inicio';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_al_final';
        $this->m_fields[] = 'class_tic_prestaciones_den:tpr_al_vencimiento';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_al_inicio")->SetDisplayValues(Array("Name"=>"tpr_al_inicio", "Label"=>"Al inicio", "Size"=>200, "IsForDB"=>true, "Order"=>114, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_al_final")->SetDisplayValues(Array("Name"=>"tpr_al_final", "Label"=>"Al final", "Size"=>200, "IsForDB"=>true, "Order"=>115, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den"));
        $this->getClass("class_tic_prestaciones_den")->GetField("tpr_al_vencimiento")->SetDisplayValues(Array("Name"=>"tpr_al_vencimiento", "Label"=>"Al vencimiento", "Size"=>200, "IsForDB"=>true, "Order"=>116, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_den"));
    }
}
}
...
if( !class_exists('class_tic_prestaciones_den_m') ) {
class class_tic_prestaciones_den_m extends cclass_maint {
    function __construct() {
		...
		$this->m_obj = new class_tic_prestaciones_den();
		$this->m_next_page = 'denprestaciones.php?last=1&OP=L'; //Pagina a mostrar luego de enviar/cancelar el formulario
		$this->m_this_page = 'denprest_maint_n.php';
        ...
        //Acciones
		$this->m_action[] = new CAction('L','Listado de prestaciones','','','denprestaciones.php?last=1&OP=L','','Listado de prestaciones','');
		$this->m_action[] = new CAction('N','Nueva prestación','','','denprest_maint_n.php?OP=N','','Nueva prestación','');

        //Grupos
		$this->m_handler[0] = new asunto_gr($this);
		$this->m_handler[1] = new ubicacion_gr($this);
		$this->m_handler[2] = new buscar_gr($this);
...
$f = new class_tic_prestaciones_den_m();
