...
include_once "class_tic_prestaciones_rec.php";
...
class asunto_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_detalle';
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_tipo';
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_ubicacion';
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_plazo';
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_show';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_detalle")->SetDisplayValues(Array("Name"=>"tpr_detalle", "Label"=>"Detalle", "Size"=>100, "IsForDB"=>true, "Order"=>103, "IsMandatory"=>true, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_tipo")->SetDisplayValues(Array("Name"=>"tpr_tipo", "Label"=>"Tipo", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>102, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_rec", "InitialValue"=>"RECLAMO"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_ubicacion")->SetDisplayValues(Array("Name"=>"tpr_ubicacion", "Label"=>"Ubicación", "Size"=>50, "IsForDB"=>true, "Order"=>108, "IsMandatory"=>true, "Presentation"=>"UBICACION", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec", "InitialValue"=>"DOMICILIO"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_plazo")->SetDisplayValues(Array("Name"=>"tpr_plazo", "Label"=>"Plazo", "Size"=>20, "IsForDB"=>true, "Order"=>109, "IsMandatory"=>true, "Presentation"=>"PLAZO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_show")->SetDisplayValues(Array("Name"=>"tpr_show", "Label"=>"Mostrar en", "Size"=>50, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec"));
    }
}
}
...
class ubicacion_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_code';
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_padre';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_code")->SetDisplayValues(Array("Name"=>"tpr_code", "Label"=>"Código", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "IsMandatory"=>true, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "Cols"=>10, "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_padre")->SetDisplayValues(Array("Name"=>"tpr_padre", "Label"=>"Prestación padre", "Size"=>20, "IsForDB"=>true, "Order"=>104, "Presentation"=>"TEXT", "IsVisible"=>true, "Cols"=>10, "Class"=>"class_tic_prestaciones_rec"));
    }
}
}
...
class buscar_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_metadata';
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_keywords';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_metadata")->SetDisplayValues(Array("Name"=>"tpr_metadata", "Label"=>"Descripción", "Size"=>3000, "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "Rows"=>5, "Cols"=>60, "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_keywords")->SetDisplayValues(Array("Name"=>"tpr_keywords", "Label"=>"Palabras clave", "Size"=>500, "IsForDB"=>true, "Order"=>112, "Presentation"=>"TEXT", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec"));
    }
}
}
...
class estado_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_estado';
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_tstamp';
        $this->m_fields[] = 'class_tic_prestaciones_rec:use_code';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_estado")->SetDisplayValues(Array("Name"=>"tpr_estado", "Label"=>"Estado", "Size"=>20, "IsForDB"=>true, "Order"=>105, "Presentation"=>"ACTIVO", "IsVisible"=>true, "Class"=>"class_tic_prestaciones_rec", "InitialValue"=>"ACTIVO"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_tstamp")->SetDisplayValues(Array("Name"=>"tpr_tstamp", "Label"=>"Fecha Act.", "Type"=>"datetime", "IsForDB"=>true, "Order"=>106, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "ClassParams"=>"force", "Class"=>"class_tic_prestaciones_rec"));
        $this->getClass("class_tic_prestaciones_rec")->GetField("use_code")->SetDisplayValues(Array("Name"=>"use_code", "Label"=>"Operador", "Size"=>50, "IsForDB"=>true, "Order"=>107, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_rec"));
    }
}
}
...
class admin_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_prestaciones_rec:tpr_admin';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_prestaciones_rec")->GetField("tpr_admin")->SetDisplayValues(Array("Name"=>"tpr_admin", "Label"=>"Administrable por", "Size"=>50, "IsForDB"=>true, "Order"=>113, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_prestaciones_rec"));
    }
}
}


if( !class_exists('class_tic_prestaciones_cuest_th5') ) {
class class_tic_prestaciones_cuest_th5 extends ctable_handler {
    function __construct($parent) {
        parent::__construct($parent);
...
if( !class_exists('class_tic_prestaciones_gis_th6') ) {
class class_tic_prestaciones_gis_th6 extends ctable_handler {
    function __construct($parent) {
        parent::__construct($parent);
...
if( !class_exists('class_tic_prestaciones_rec_m') ) {
class class_tic_prestaciones_rec_m extends cclass_maint {
    function __construct() {
        ...
        //Acciones
		$this->m_action[] = new CAction('L','Listado de prestaciones','','','recprestaciones.php?last=1&OP=L','','Listado de prestaciones','');
		$this->m_action[] = new CAction('N','Nueva prestación','','','recprest_maint_n.php?OP=N','','Nueva prestación','');
        ...
        //Tablas
		$this->m_handler[5] = new class_tic_prestaciones_cuest_th5($this);
		$this->m_handler[6] = new class_tic_prestaciones_gis_th6($this);
...
$f = new class_tic_prestaciones_rec_m();
