...
include_once "class_tic_ticket_upd_sol.php";
...
class accion_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_ticket_upd_sol:acc_estado';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:acc_tpr_code';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:acc_tor_code';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:acc_nota';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:acc_use_code';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:acc_tstamp';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_estado")->SetDisplayValues(Array("Name"=>"acc_estado", "Label"=>"Nuevo Estado", "Size"=>50, "Order"=>24, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true, "ClassParams"=>"operaciones", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_tpr_code")->SetDisplayValues(Array("Name"=>"acc_tpr_code", "Label"=>"Prestación", "Size"=>50, "Order"=>23, "Presentation"=>"PRESTACION_TICKET", "IsVisible"=>true, "ClassParams"=>"tic_nro|tic_anio|tic_tipo", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_tor_code")->SetDisplayValues(Array("Name"=>"acc_tor_code", "Label"=>"Nuevo responsable", "Type"=>"int", "Order"=>30, "Presentation"=>"ORGANISMO", "IsVisible"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_nota")->SetDisplayValues(Array("Name"=>"acc_nota", "Label"=>"Nota", "Size"=>500, "Order"=>25, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "Rows"=>4, "Cols"=>60, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_use_code")->SetDisplayValues(Array("Name"=>"acc_use_code", "Label"=>"Operador", "Size"=>50, "Order"=>26, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "ClassParams"=>"force", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_tstamp")->SetDisplayValues(Array("Name"=>"acc_tstamp", "Label"=>"Fecha", "Type"=>"datetime", "Order"=>27, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "ClassParams"=>"force", "Class"=>"class_tic_ticket_upd_sol"));
    }
}
}
...
class ubicacion_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_lugar';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:mapa';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_id_cuadra';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_coordx';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_coordy';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_barrio';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_cgpc';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_calle_nombre';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_nro_puerta';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_lugar")->SetDisplayValues(Array("Name"=>"tic_lugar", "Label"=>"Dirección", "Size"=>1000, "IsForDB"=>true, "Order"=>108, "Presentation"=>"DIRECCION", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("mapa")->SetDisplayValues(Array("Name"=>"mapa", "Label"=>"Ubicación", "Size"=>50, "Order"=>22, "Presentation"=>"MAPA", "IsVisible"=>true, "IsReadOnly"=>true, "Rows"=>150, "Cols"=>150, "ClassParams"=>"tic_coordx|tic_coordy", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_id_cuadra")->SetDisplayValues(Array("Name"=>"tic_id_cuadra", "Label"=>"IdCuadra", "Type"=>"int", "IsForDB"=>true, "Order"=>113, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_coordx")->SetDisplayValues(Array("Name"=>"tic_coordx", "Label"=>"x", "Type"=>"float", "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_coordy")->SetDisplayValues(Array("Name"=>"tic_coordy", "Label"=>"y", "Type"=>"float", "IsForDB"=>true, "Order"=>112, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_barrio")->SetDisplayValues(Array("Name"=>"tic_barrio", "Label"=>"Barrio", "Size"=>50, "IsForDB"=>true, "Order"=>109, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_cgpc")->SetDisplayValues(Array("Name"=>"tic_cgpc", "Label"=>"CGPC", "Size"=>20, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_calle_nombre")->SetDisplayValues(Array("Name"=>"tic_calle_nombre", "Label"=>"Calle", "Size"=>100, "IsForDB"=>true, "Order"=>118, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_nro_puerta")->SetDisplayValues(Array("Name"=>"tic_nro_puerta", "Label"=>"Altura", "Type"=>"int", "IsForDB"=>true, "Order"=>119, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
    }
}
}
...
class estado_gr extends cform_group {
    function __construct($parent) {
        ...
        //Campos del grupo
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_nro';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_anio';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_tipo';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_tstamp_in';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_tstamp_plazo';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_tstamp_cierre';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_estado';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_canal';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_nota_in';
        $this->m_fields[] = 'class_tic_ticket_upd_sol:tic_forms';

    }

    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_nro")->SetDisplayValues(Array("Name"=>"tic_nro", "Label"=>"Número", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>101, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_anio")->SetDisplayValues(Array("Name"=>"tic_anio", "Label"=>"Año", "Type"=>"int", "IsPK"=>true, "IsForDB"=>true, "Order"=>102, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsPK"=>true, "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tstamp_in")->SetDisplayValues(Array("Name"=>"tic_tstamp_in", "Label"=>"Ingreso Denuncia", "Type"=>"datetime", "IsForDB"=>true, "Order"=>104, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tstamp_plazo")->SetDisplayValues(Array("Name"=>"tic_tstamp_plazo", "Label"=>"Fec.Cierre estimado", "Type"=>"datetime", "IsForDB"=>true, "Order"=>116, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tstamp_cierre")->SetDisplayValues(Array("Name"=>"tic_tstamp_cierre", "Label"=>"Fec.Cierre Denuncia", "Type"=>"datetime", "IsForDB"=>true, "Order"=>117, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_estado")->SetDisplayValues(Array("Name"=>"tic_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>107, "Presentation"=>"ESTADO_TICKET", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_canal")->SetDisplayValues(Array("Name"=>"tic_canal", "Label"=>"Ingresada por", "Size"=>20, "IsForDB"=>true, "Order"=>115, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_nota_in")->SetDisplayValues(Array("Name"=>"tic_nota_in", "Label"=>"Nota al ingreso", "Size"=>500, "IsForDB"=>true, "Order"=>106, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_forms")->SetDisplayValues(Array("Name"=>"tic_forms", "Label"=>"Id", "Type"=>"int", "IsForDB"=>true, "Order"=>114, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
    }
}
}
...
class class_tic_avance_th3 extends ctable_handler {
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("tic_estado_in")->SetDisplayValues(Array("Name"=>"tic_estado_in", "Label"=>"Estado inicial", "Size"=>50, "IsForDB"=>true, "Order"=>107, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
        $obj->GetField("tic_estado_out")->SetDisplayValues(Array("Name"=>"tic_estado_out", "Label"=>"Estado final", "Size"=>50, "IsForDB"=>true, "Order"=>108, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
...
class class_tic_ticket_prestaciones_th4 extends ctable_handler {
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("ttp_estado")->SetDisplayValues(Array("Name"=>"ttp_estado", "Label"=>"Estado", "Size"=>10, "IsForDB"=>true, "Order"=>108, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true, "IsReadOnly"=>true, "InitialValue"=>"INICIADA"));
    }
...
if( !class_exists('class_tic_ticket_upd_sol_m') ) {
class class_tic_ticket_upd_sol_m extends cclass_maint {
    function __construct() {
		...
		$this->m_obj = new class_tic_ticket_upd_sol();
		$this->m_next_page = 'solabiertas.php?last=1&OP=L'; //Pagina a mostrar luego de enviar/cancelar el formulario
		$this->m_this_page = 'solicitud_maint.php';
    	$this->m_save_to_type = 'DB'; //Si el formulario accede directo a las tablas o hace una transaccion
    	$this->m_view = ''; //Si se presenta como sabana o como wizard
    	$this->m_operation_allow = 'VNMPSDB'; //Lista de operaciones permitidas
    	$this->m_operation_default = 'V'; //Operacion por defecto
    	$this->m_title = 'Actualización de una solicitud';// Titulo del formulario
    	$this->m_comment = '';// Comentario del formulario
        ...
        //Acciones
		$this->m_action[] = new CAction('P','Imprimir comprobante','','','solicitud_maint.php?OP=P','tic_nro|tic_anio|tic_tipo|','Imprimir comprobante','');
		$this->m_action[] = new CAction('L','Consulta de solicitudes','','','solabiertas.php?last=1&OP=L','','Consulta de solicitudes','');
		$this->m_action[] = new CAction('L','Consulta de novedades','','','solnovedades.php?last=1&OP=L','','Consulta de novedades','');
...
$f = new class_tic_ticket_upd_sol_m();
