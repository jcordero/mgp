...
class accion_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_estado")->SetDisplayValues(Array("Name"=>"acc_estado", "Label"=>"Nuevo Estado", "Size"=>50, "Order"=>26, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true, "ClassParams"=>"operaciones", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_tpr_code")->SetDisplayValues(Array("Name"=>"acc_tpr_code", "Label"=>"Prestación", "Size"=>50, "Order"=>25, "Presentation"=>"PRESTACION_TICKET", "IsVisible"=>true, "ClassParams"=>"tic_nro|tic_anio|tic_tipo", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_tor_code")->SetDisplayValues(Array("Name"=>"acc_tor_code", "Label"=>"Nuevo responsable", "Type"=>"int", "Order"=>32, "Presentation"=>"ORGANISMO", "IsVisible"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_nota")->SetDisplayValues(Array("Name"=>"acc_nota", "Label"=>"Nota", "Size"=>500, "Order"=>27, "Presentation"=>"TEXTAREA", "IsVisible"=>true, "Rows"=>4, "Cols"=>60, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_use_code")->SetDisplayValues(Array("Name"=>"acc_use_code", "Label"=>"Operador", "Size"=>50, "Order"=>28, "Presentation"=>"CURRENTUSER", "IsVisible"=>true, "ClassParams"=>"force", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("acc_tstamp")->SetDisplayValues(Array("Name"=>"acc_tstamp", "Label"=>"Fecha", "Type"=>"datetime", "Order"=>29, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "ClassParams"=>"force", "Class"=>"class_tic_ticket_upd_sol"));
    }
}
}
...
class ubicacion_gr extends cform_group {
    ...
    public function InitializeInstance() {
        //SetDisplayValues($attributes) 
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_lugar")->SetDisplayValues(Array("Name"=>"tic_lugar", "Label"=>"Dirección", "Size"=>1000, "IsForDB"=>true, "Order"=>109, "Presentation"=>"DIRECCION", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("mapa")->SetDisplayValues(Array("Name"=>"mapa", "Label"=>"Ubicación", "Size"=>50, "Order"=>24, "Presentation"=>"MAPA", "IsVisible"=>true, "IsReadOnly"=>true, "Rows"=>150, "Cols"=>150, "ClassParams"=>"tic_coordx|tic_coordy", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_id_cuadra")->SetDisplayValues(Array("Name"=>"tic_id_cuadra", "Label"=>"IdCuadra", "Type"=>"int", "IsForDB"=>true, "Order"=>114, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_coordx")->SetDisplayValues(Array("Name"=>"tic_coordx", "Label"=>"x", "Type"=>"double", "IsForDB"=>true, "Order"=>112, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_coordy")->SetDisplayValues(Array("Name"=>"tic_coordy", "Label"=>"y", "Type"=>"double", "IsForDB"=>true, "Order"=>113, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_barrio")->SetDisplayValues(Array("Name"=>"tic_barrio", "Label"=>"Barrio", "Size"=>50, "IsForDB"=>true, "Order"=>110, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_cgpc")->SetDisplayValues(Array("Name"=>"tic_cgpc", "Label"=>"CGPC", "Size"=>20, "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_calle_nombre")->SetDisplayValues(Array("Name"=>"tic_calle_nombre", "Label"=>"Calle", "Size"=>100, "IsForDB"=>true, "Order"=>119, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_nro_puerta")->SetDisplayValues(Array("Name"=>"tic_nro_puerta", "Label"=>"Altura", "Type"=>"int", "IsForDB"=>true, "Order"=>121, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
    }
}
}
...
class estado_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_anio")->SetDisplayValues(Array("Name"=>"tic_anio", "Label"=>"Año", "Type"=>"int", "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsForDB"=>true, "Order"=>104, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tstamp_in")->SetDisplayValues(Array("Name"=>"tic_tstamp_in", "Label"=>"Ingreso Denuncia", "Type"=>"datetime", "IsForDB"=>true, "Order"=>105, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tstamp_plazo")->SetDisplayValues(Array("Name"=>"tic_tstamp_plazo", "Label"=>"Fec.Cierre estimado", "Type"=>"datetime", "IsForDB"=>true, "Order"=>117, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tstamp_cierre")->SetDisplayValues(Array("Name"=>"tic_tstamp_cierre", "Label"=>"Fec.Cierre Denuncia", "Type"=>"datetime", "IsForDB"=>true, "Order"=>118, "Presentation"=>"DATETIME", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_estado")->SetDisplayValues(Array("Name"=>"tic_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>108, "Presentation"=>"ESTADO_TICKET", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_canal")->SetDisplayValues(Array("Name"=>"tic_canal", "Label"=>"Ingresada por", "Size"=>20, "IsForDB"=>true, "Order"=>116, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_nota_in")->SetDisplayValues(Array("Name"=>"tic_nota_in", "Label"=>"Nota al ingreso", "Size"=>500, "IsForDB"=>true, "Order"=>107, "Presentation"=>"TEXT", "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_forms")->SetDisplayValues(Array("Name"=>"tic_forms", "Label"=>"Id", "Type"=>"int", "IsForDB"=>true, "Order"=>115, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
    }
}
}
