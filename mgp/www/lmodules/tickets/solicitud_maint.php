...
class ubicacion_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_coordx")->SetDisplayValues(Array("Name"=>"tic_coordx", "Label"=>"x", "Type"=>"double", "IsForDB"=>true, "Order"=>111, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_coordy")->SetDisplayValues(Array("Name"=>"tic_coordy", "Label"=>"y", "Type"=>"double", "IsForDB"=>true, "Order"=>112, "Presentation"=>"TEXT", "Class"=>"class_tic_ticket_upd_sol"));
...
class estado_gr extends cform_group {
    ...
    public function InitializeInstance() {
        ...
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_anio")->SetDisplayValues(Array("Name"=>"tic_anio", "Label"=>"Año", "Type"=>"int", "IsForDB"=>true, "Order"=>102, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
        $this->getClass("class_tic_ticket_upd_sol")->GetField("tic_tipo")->SetDisplayValues(Array("Name"=>"tic_tipo", "Label"=>"Tipo", "Size"=>20, "IsForDB"=>true, "Order"=>103, "Presentation"=>"TEXT", "IsNullable"=>false, "IsVisible"=>true, "IsReadOnly"=>true, "Class"=>"class_tic_ticket_upd_sol"));
...
class class_tic_avance_th3 extends ctable_handler {
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("tic_estado_in")->SetDisplayValues(Array("Name"=>"tic_estado_in", "Label"=>"Estado inicial", "Size"=>50, "IsForDB"=>true, "Order"=>106, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
        ...
        $obj->GetField("tic_estado_out")->SetDisplayValues(Array("Name"=>"tic_estado_out", "Label"=>"Estado final", "Size"=>50, "IsForDB"=>true, "Order"=>109, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true));
...
class class_tic_ticket_prestaciones_th4 extends ctable_handler {
    ...
    public function InitializeInstance($obj) {
        ...
        $obj->GetField("ttp_estado")->SetDisplayValues(Array("Name"=>"ttp_estado", "Label"=>"Estado", "Size"=>50, "IsForDB"=>true, "Order"=>105, "Presentation"=>"ESTADO_SOLICITUD", "IsVisible"=>true, "IsReadOnly"=>true, "InitialValue"=>"INICIADA"));
    }
...
class class_tic_ticket_upd_sol_m extends cclass_maint {
    function __construct() {
        ...
        //Acciones
		$this->m_action[] = new CAction('P','Imprimir comprobante','','','solicitud_maint.php?OP=P','tic_nro|','Imprimir comprobante','');
