 ...
 * 		
 */
function chg_villa(obj)
{
	//Cual es la villa elegida?
	var ix = obj.selectedIndex;
	var villa = "";
	if(ix!=-1)
	{
		villa = obj.options[ix].value;
	}
	else
	{
		return;
	...
	var json = rem_sync_request("VILLA","getVillaDetails",villa);
	if(json=="")
	{
	...
	if(params.length!=7)
	{
		alert("El objeto VILLA requiere 7 parametros");
		return;
	}
