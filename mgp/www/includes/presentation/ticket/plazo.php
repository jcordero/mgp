...
class CDH_PLAZO extends CDataHandler
{
    function __construct($parent) 
    {
        ...
        $fld->m_js_totext = "plazo_totext"; 
        $fld->m_js_tovalue = "plazo_totext"; 
        $fld->m_js_edit = "plazo_edit"; 
    }
    ...
    {	
        return '<script type="text/javascript" src="'.WEB_PATH.'/includes/presentation/ticket/plazo.js"></script>';
    }
}
?>