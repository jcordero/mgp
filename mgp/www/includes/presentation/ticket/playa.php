...
class CDH_PLAYA extends CDH_SELECTARRAY 
{
	function __construct($parent) 
	{
		...
		$parent->m_js_click = "chg_playa(this)";
	...
	{	
		return '<script type="text/javascript" src="'.WEB_PATH.'/includes/presentation/ticket/playa.js"></script>';
	}
	
	function getPlayaDetails($plaza)
    {
        global $primary_db;
