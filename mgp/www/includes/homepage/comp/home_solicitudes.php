<?php 
/* Pantalla inicial para el operador de solicitudes
 *
 ...
 * 
 */
if(!class_exists('home_solicitudes'))
{
	...
	class home_denuncias
	{
		public function Render($context)
		{
            ...
            $html.= '<div id="home_solicitudes" class="apTabs">';
...
//Ingresos
            ...
            foreach($dias as $dia => $cant)
            {
           	...
           	if($k==0)
           	{
           		$xml = "<?xml version='1.0' encoding='UTF-8' ?><graph showNames='1' decimalPrecision='0' yaxismaxvalue='10' caption='Ingresos de solicitudes (últimos 30 días)'>".$xml;
           	}
           	else
           	{
           		$xml = "<?xml version='1.0' encoding='UTF-8' ?><graph showNames='1' decimalPrecision='0' caption='Ingresos de solicitudes (últimos 30 días)'>".$xml;
           	}
...
//Cierres
            ...
            foreach($dias as $dia => $cant)
            {
           	...
           	if($k==0)
           	{
	           	$xml = "<?xml version='1.0' encoding='UTF-8' ?><graph showNames='1' decimalPrecision='0' yaxismaxvalue='10' caption='Cierres de solicitudes (últimos 30 días)'>".$xml;
           	}
           	else
           	{
           		$xml = "<?xml version='1.0' encoding='UTF-8' ?><graph showNames='1' decimalPrecision='0' caption='Cierres de solicitudes (últimos 30 días)'>".$xml;
           	}
